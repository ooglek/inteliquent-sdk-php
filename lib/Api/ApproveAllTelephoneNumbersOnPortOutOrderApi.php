<?php
/**
 * ApproveAllTelephoneNumbersOnPortOutOrderApi
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ApproveAllTelephoneNumbersOnPortOutOrderApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApproveAllTelephoneNumbersOnPortOutOrderApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \OpenAPI\Client\Model\InlineResponse20013|\OpenAPI\Client\Model\InlineResponse40822|\OpenAPI\Client\Model\InlineResponse414|\OpenAPI\Client\Model\InlineResponse430|\OpenAPI\Client\Model\InlineResponse431|\OpenAPI\Client\Model\InlineResponse4324
     */
    public function portOutApprovalPost($payload)
    {
        list($response) = $this->portOutApprovalPostWithHttpInfo($payload);
        return $response;
    }

    /**
     * Operation portOutApprovalPostWithHttpInfo
     *
     * Approve Port-Out Telephone Numbers
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse20013|\OpenAPI\Client\Model\InlineResponse40822|\OpenAPI\Client\Model\InlineResponse414|\OpenAPI\Client\Model\InlineResponse430|\OpenAPI\Client\Model\InlineResponse431|\OpenAPI\Client\Model\InlineResponse4324, HTTP status code, HTTP response headers (array of strings)
     */
    public function portOutApprovalPostWithHttpInfo($payload)
    {
        $request = $this->portOutApprovalPostRequest($payload);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 408:
                    if ('\OpenAPI\Client\Model\InlineResponse40822' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InlineResponse40822', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 414:
                ...
                case 432:
                    if ('\OpenAPI\Client\Model\InlineResponse4324' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InlineResponse4324', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 408:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InlineResponse40822',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 432:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InlineResponse4324',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation portOutApprovalPostAsync
     *
     * Approve Port-Out Telephone Numbers
     *
     * @param  \OpenAPI\Client\Model\InlineObject135 $payload (required)
     ...
     */
    public function portOutApprovalPostAsync($payload)
    {
        return $this->portOutApprovalPostAsyncWithHttpInfo($payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation portOutApprovalPostAsyncWithHttpInfo
     *
     * Approve Port-Out Telephone Numbers
     *
     * @param  \OpenAPI\Client\Model\InlineObject135 $payload (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function portOutApprovalPostAsyncWithHttpInfo($payload)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20013';
        $request = $this->portOutApprovalPostRequest($payload);
     ...
     */
    public function portOutApprovalPostRequest($payload)
    {
        // verify the required parameter 'payload' is set
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling portOutApprovalPost'
            );
        }

        $resourcePath = '/portOutApproval';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
