...
/**
 * TnPortOutPinApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class TnPortOutPinApi
{
    ...
    /**
     * Operation tnPortOutPinDetailPost
     *
     ...
     * @return \OpenAPI\Client\Model\ResponseTnPortOutPin|\OpenAPI\Client\Model\InlineResponse4082
     */
    public function tnPortOutPinDetailPost($payload)
    {
        list($response) = $this->tnPortOutPinDetailPostWithHttpInfo($payload);
        return $response;
    }

    /**
     * Operation tnPortOutPinDetailPostWithHttpInfo
     *
     * Assigned TN Port Out PIN
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ResponseTnPortOutPin|\OpenAPI\Client\Model\InlineResponse4082, HTTP status code, HTTP response headers (array of strings)
     */
    public function tnPortOutPinDetailPostWithHttpInfo($payload)
    {
        $request = $this->tnPortOutPinDetailPostRequest($payload);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ResponseTnPortOutPin' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ResponseTnPortOutPin', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ResponseTnPortOutPin';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ResponseTnPortOutPin',
    ...
    /**
     * Operation tnPortOutPinDetailPostAsync
     *
     * Assigned TN Port Out PIN
     *
     * @param  \OpenAPI\Client\Model\InlineObject137 $payload (required)
     ...
     */
    public function tnPortOutPinDetailPostAsync($payload)
    {
        return $this->tnPortOutPinDetailPostAsyncWithHttpInfo($payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tnPortOutPinDetailPostAsyncWithHttpInfo
     *
     * Assigned TN Port Out PIN
     *
     * @param  \OpenAPI\Client\Model\InlineObject137 $payload (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tnPortOutPinDetailPostAsyncWithHttpInfo($payload)
    {
        $returnType = '\OpenAPI\Client\Model\ResponseTnPortOutPin';
        $request = $this->tnPortOutPinDetailPostRequest($payload);
     ...
     */
    public function tnPortOutPinDetailPostRequest($payload)
    {
        // verify the required parameter 'payload' is set
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling tnPortOutPinDetailPost'
            );
        }

        $resourcePath = '/tnPortOutPinDetail';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
