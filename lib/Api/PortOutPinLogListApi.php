...
/**
 * PortOutPinLogListApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class PortOutPinLogListApi
{
    ...
    /**
     * Operation portOutPinLogListPost
     *
     * Log list associated with PortOut PINs
     *
     * @param  \OpenAPI\Client\Model\InlineObject138 $payload payload (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ResponsePortOutPinLogList|\OpenAPI\Client\Model\InlineResponse4082
     */
    public function portOutPinLogListPost($payload)
    {
        list($response) = $this->portOutPinLogListPostWithHttpInfo($payload);
        return $response;
    }

    /**
     * Operation portOutPinLogListPostWithHttpInfo
     *
     * Log list associated with PortOut PINs
     *
     * @param  \OpenAPI\Client\Model\InlineObject138 $payload (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ResponsePortOutPinLogList|\OpenAPI\Client\Model\InlineResponse4082, HTTP status code, HTTP response headers (array of strings)
     */
    public function portOutPinLogListPostWithHttpInfo($payload)
    {
        $request = $this->portOutPinLogListPostRequest($payload);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ResponsePortOutPinLogList' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ResponsePortOutPinLogList', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ResponsePortOutPinLogList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ResponsePortOutPinLogList',
    ...
    /**
     * Operation portOutPinLogListPostAsync
     *
     * Log list associated with PortOut PINs
     *
     * @param  \OpenAPI\Client\Model\InlineObject138 $payload (required)
     ...
     */
    public function portOutPinLogListPostAsync($payload)
    {
        return $this->portOutPinLogListPostAsyncWithHttpInfo($payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation portOutPinLogListPostAsyncWithHttpInfo
     *
     * Log list associated with PortOut PINs
     *
     * @param  \OpenAPI\Client\Model\InlineObject138 $payload (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function portOutPinLogListPostAsyncWithHttpInfo($payload)
    {
        $returnType = '\OpenAPI\Client\Model\ResponsePortOutPinLogList';
        $request = $this->portOutPinLogListPostRequest($payload);
    ...
    /**
     * Create request for operation 'portOutPinLogListPost'
     *
     * @param  \OpenAPI\Client\Model\InlineObject138 $payload (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function portOutPinLogListPostRequest($payload)
    {
        // verify the required parameter 'payload' is set
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling portOutPinLogListPost'
            );
        }

        $resourcePath = '/portOutPinLogList';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
