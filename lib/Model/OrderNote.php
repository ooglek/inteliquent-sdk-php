 ...
 */
class OrderNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderNote';
    ...
    protected static $openAPITypes = [
        'status_code' => 'string',
        'status' => 'string',
        'order_note' => '\OpenAPI\Client\Model\OrderNoteOrderNote'
    ];
     ...
     * Gets order_note
     *
     * @return \OpenAPI\Client\Model\OrderNoteOrderNote|null
     */
     ...
     * Sets order_note
     *
     * @param \OpenAPI\Client\Model\OrderNoteOrderNote|null $order_note order_note
     *
     * @return self
     */
