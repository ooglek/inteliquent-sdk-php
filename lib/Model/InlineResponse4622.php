...
/**
 * InlineResponse4622 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4622 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_462_2';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 462
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Other Errors Noted  | Unable to process the request at the moment
     *
     * @return self
     */
