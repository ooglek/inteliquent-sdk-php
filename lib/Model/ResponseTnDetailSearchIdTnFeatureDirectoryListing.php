...
/**
 * ResponseTnDetailSearchIdTnFeatureDirectoryListing Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnDetailSearchIdTnFeatureDirectoryListing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnDetail_searchId_tnFeature_directoryListing';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_complex_dl'] = $data['is_complex_dl'] ?? null;
    }
     ...
     * @return string|null
     */
    public function getIsComplexDl()
    {
        return $this->container['is_complex_dl'];
    }

    /**
     * Sets is_complex_dl
     *
     * @param string|null $is_complex_dl Whether DL is complex or not. (Y/N)
     *
     * @return self
     */
    public function setIsComplexDl($is_complex_dl)
    {
        $this->container['is_complex_dl'] = $is_complex_dl;
