...
class InlineObject18 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'private_key' => 'string',
        'brand_order' => '\OpenAPI\Client\Model\BrandOrderBrandOrder'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['brand_order'] = $data['brand_order'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['brand_order'] === null) {
            $invalidProperties[] = "'brand_order' can't be null";
        }
     ...
     * Gets brand_order
     *
     * @return \OpenAPI\Client\Model\BrandOrderBrandOrder
     */
    public function getBrandOrder()
    {
        return $this->container['brand_order'];
    }

    /**
     * Sets brand_order
     *
     * @param \OpenAPI\Client\Model\BrandOrderBrandOrder $brand_order brand_order
     *
     * @return self
     */
    public function setBrandOrder($brand_order)
    {
        $this->container['brand_order'] = $brand_order;
