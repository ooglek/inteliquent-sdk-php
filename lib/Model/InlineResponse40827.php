...
/**
 * InlineResponse40827 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40827 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_408_27';
     ...
     * Sets status
     *
     * @param string|null $status Private Key cannot be blank.| International Order is not allowed for customer.
     *
     * @return self
     */
