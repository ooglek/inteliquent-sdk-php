...
class InlineObject39 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['primary_private_key'] === null) {
            $invalidProperties[] = "'primary_private_key' can't be null";
        }
     ...
     *
     * @param string $primary_private_key Existing primary key for the customer.
     *
     * @return self
     */
     ...
     * Sets key_name
     *
     * @param string|null $key_name An optional name to identify the key being generated
     *
     * @return self
     */
