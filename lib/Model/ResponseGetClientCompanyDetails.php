<?php
/**
 * ResponseGetClientCompanyDetails
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseGetClientCompanyDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseGetClientCompanyDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseGetClient_companyDetails';
    ...
    protected static $openAPITypes = [
        'client_keys' => '\OpenAPI\Client\Model\ResponseGetClientCompanyDetailsClientKeys[]'
    ];
    ...
    {
        $this->container['client_keys'] = $data['client_keys'] ?? null;
    }
     ...
     * Gets client_keys
     *
     * @return \OpenAPI\Client\Model\ResponseGetClientCompanyDetailsClientKeys[]|null
     */
    public function getClientKeys()
    {
        return $this->container['client_keys'];
    }

    /**
     * Sets client_keys
     *
     * @param \OpenAPI\Client\Model\ResponseGetClientCompanyDetailsClientKeys[]|null $client_keys Array of keys
     *
     * @return self
     */
    public function setClientKeys($client_keys)
    {
        $this->container['client_keys'] = $client_keys;
