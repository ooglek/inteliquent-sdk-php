...
class InlineObject30 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['messaging_campaign_id'] === null) {
            $invalidProperties[] = "'messaging_campaign_id' can't be null";
        }
     ...
     *
     * @param string|null $external_campaign_id External Campaign ID
     *
     * @return self
     */
     ...
     *
     * @param string $messaging_campaign_id Messaging Campaign ID
     *
     * @return self
     */
