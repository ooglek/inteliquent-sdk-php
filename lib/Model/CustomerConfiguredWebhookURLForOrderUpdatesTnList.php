<?php
/**
 * CustomerConfiguredWebhookURLForOrderUpdatesTnList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CustomerConfiguredWebhookURLForOrderUpdatesTnList Class Doc Comment
 *
 * @category Class
 * @description Contains telephone number(s) to be updated
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomerConfiguredWebhookURLForOrderUpdatesTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_customerConfiguredWebhookURLForOrderUpdates_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\CustomerConfiguredWebhookURLForOrderUpdatesTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\CustomerConfiguredWebhookURLForOrderUpdatesTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\CustomerConfiguredWebhookURLForOrderUpdatesTnListTnItem[]|null $tn_item Contains telephone number(s) to be updated
     *
     * @return self
     */
