<?php
/**
 * TnNoteUpdateTnNoteTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnNoteUpdateTnNoteTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnNoteUpdateTnNoteTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnNoteUpdate_tnNote_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number to add note (e.g. 8156680000)
     *
     * @return self
     */
     ...
     * Sets tn_note
     *
     * @param string $tn_note Note text to apply to the number
     *
     * @return self
     */
