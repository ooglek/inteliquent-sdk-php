...
class InlineResponse2007 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'string',
        'status' => 'string',
        'time_profiles' => '\OpenAPI\Client\Model\InlineResponse2007TimeProfiles[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['time_profiles'] = $data['time_profiles'] ?? null;
    }
     ...
     * Gets time_profiles
     *
     * @return \OpenAPI\Client\Model\InlineResponse2007TimeProfiles[]|null
     */
    public function getTimeProfiles()
    {
        return $this->container['time_profiles'];
    }

    /**
     * Sets time_profiles
     *
     * @param \OpenAPI\Client\Model\InlineResponse2007TimeProfiles[]|null $time_profiles List of time profiles
     *
     * @return self
     */
    public function setTimeProfiles($time_profiles)
    {
        $this->container['time_profiles'] = $time_profiles;
