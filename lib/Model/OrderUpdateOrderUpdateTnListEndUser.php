<?php
/**
 * OrderUpdateOrderUpdateTnListEndUser
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * OrderUpdateOrderUpdateTnListEndUser Class Doc Comment
 *
 * @category Class
 * @description End user information for the telephone number
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OrderUpdateOrderUpdateTnListEndUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orderUpdate_orderUpdate_tnList_endUser';
     ...
     * Sets name
     *
     * @param string|null $name End user name
     *
     * @return self
     */
     ...
     * Sets street_num
     *
     * @param string|null $street_num End user address street number (e.g. 100, 550)
     *
     * @return self
     */
     ...
     * Sets street_pre_dir
     *
     * @param string|null $street_pre_dir End user address street direction prefix (e.g. N)
     *
     * @return self
     */
     ...
     * Sets street_type
     *
     * @param string|null $street_type End user address street type (e.g. St, Ave)
     *
     * @return self
     */
     ...
     *
     * @param string|null $street_post_dir End user address street direction ending (e.g. SW)
     *
     * @return self
     */
     ...
     * Sets location_type1
     *
     * @param string|null $location_type1 End user address location type 1 (e.g. Bld, Apt)
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_value1 user address location value 1 (e.g. 1, 2B)
     *
     * @return self
     */
     ...
     * Sets location_type2
     *
     * @param string|null $location_type2 End user address location type 2 (e.g. Flr, Ste)
     *
     * @return self
     */
     ...
     *
     * @param string|null $location_value2 End user address location value 2 (e.g. 1, 900)
     *
     * @return self
     */
     ...
     *
     * @param string|null $type_of_service Acceptable values are B and R (business and residence)
     *
     * @return self
     */
