...
/**
 * TfOrderTfOrderTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfOrderTfOrderTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfOrder_tfOrder_tnList_tnItem';
    ...
    protected static $openAPITypes = [
        ...
        'tn_note' => 'string',
        'cic_list' => '\OpenAPI\Client\Model\TfOrderTfOrderTnListCicList',
        'tn_feature' => '\OpenAPI\Client\Model\TfOrderTfOrderTnListTnFeature',
        'dnis' => 'string',
        'billing_tn' => 'string',
        'term_tn' => 'string'
    ];
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit toll free number (e.g. 8776680000)
     *
     * @return self
     */
     ...
     * Sets resporg_id
     *
     * @param string|null $resporg_id Five character RespOrg ID for the toll free number; must belong to your company if productAbbr is 8XX
     *
     * @return self
     */
     ...
     * Gets cic_list
     *
     * @return \OpenAPI\Client\Model\TfOrderTfOrderTnListCicList|null
     */
     ...
     * Sets cic_list
     *
     * @param \OpenAPI\Client\Model\TfOrderTfOrderTnListCicList|null $cic_list cic_list
     *
     * @return self
     */
     ...
     * Gets tn_feature
     *
     * @return \OpenAPI\Client\Model\TfOrderTfOrderTnListTnFeature|null
     */
     ...
     * Sets tn_feature
     *
     * @param \OpenAPI\Client\Model\TfOrderTfOrderTnListTnFeature|null $tn_feature tn_feature
     *
     * @return self
     */
     ...
     * Sets dnis
     *
     * @param string|null $dnis New or updated dnis value
     *
     * @return self
     */
     ...
     * Sets billing_tn
     *
     * @param string|null $billing_tn Ten digit billing Tn (e.g. 8776681234)
     *
     * @return self
     */
     ...
     * Sets term_tn
     *
     * @param string|null $term_tn Ten digit terminating Tn (e.g. 8776683456). termTn is allowed if switched toll free enabled and if termTn is present dnis and routingLabel should not be sent. Either Dnis or Term Tn or routingLabel should be sent.
     *
     * @return self
     */
