<?php
/**
 * PortOutPinUpdatePortOutPinTnList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PortOutPinUpdatePortOutPinTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active telephone number(s) to add PIN(s)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PortOutPinUpdatePortOutPinTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_portOutPinUpdate_portOutPin_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\PortOutPinUpdatePortOutPinTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\PortOutPinUpdatePortOutPinTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\PortOutPinUpdatePortOutPinTnListTnItem[]|null $tn_item Contains active telephone number(s) to add PIN(s)
     *
     * @return self
     */
