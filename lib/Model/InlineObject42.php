...
class InlineObject42 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'primary_private_key' => 'setPrimaryPrivateKey',
    ...
    protected static $getters = [
        'primary_private_key' => 'getPrimaryPrivateKey',
    ...
    {
        $this->container['primary_private_key'] = $data['primary_private_key'] ?? null;
    ...
    /**
     * Gets primary_private_key
     *
     * @return string|null
     */
    public function getPrimaryPrivateKey()
    {
        return $this->container['primary_private_key'];
    }

    /**
     * Sets primary_private_key
     *
     * @param string|null $primary_private_key Existing primary key for the customer.
     *
     * @return self
     */
    public function setPrimaryPrivateKey($primary_private_key)
    {
        $this->container['primary_private_key'] = $primary_private_key;
     ...
     * Sets private_key
     *
     * @param string $private_key Existing key for the customer that needs to be updated.
     *
     * @return self
     */
     ...
     * Sets key_name
     *
     * @param string|null $key_name Indicates whether the key being created is a primary or not. If this is the first key for the Customer, then it will automatically be considered and setup as a primary key.
     *
     * @return self
     */
     ...
     * Sets is_primary
     *
     * @param bool|null $is_primary Indicates whether the key being created is a primary or not. If this is the first key for the Customer, then it will automatically be considered and setup as a primary key.
     *
     * @return self
     */
