<?php
/**
 * TnOrderTnOrderTnListTnFeatureCallerId
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnOrderTnOrderTnListTnFeatureCallerId Class Doc Comment
 *
 * @category Class
 * @description Changes to caller ID (CNAM)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnOrderTnOrderTnListTnFeatureCallerId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnOrder_tnOrder_tnList_tnFeature_callerId';
     ...
     * Sets calling_name
     *
     * @param string|null $calling_name New or updated caller ID outbound display name (LIDB storage); 15 characters or fewer
     *
     * @return self
     */
     ...
     * Sets cancel_feature
     *
     * @param string|null $cancel_feature Enter Y to cancel a request to add caller ID information to the telephone number
     *
     * @return self
     */
     ...
     * Sets cnam_dip
     *
     * @param string|null $cnam_dip Change CNAM delivery for inbound calls / CNAM dip; acceptable values are Y and N
     *
     * @return self
     */
