...
/**
 * InlineResponse4153 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4153 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_415_3';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 415
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Domain cannot be specified more than once
     *
     * @return self
     */
