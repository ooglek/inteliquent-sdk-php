...
/**
 * InlineResponse4206 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4206 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_420_6';
     ...
     * Sets status
     *
     * @param string|null $status Switched Toll free is not enabled
     *
     * @return self
     */
