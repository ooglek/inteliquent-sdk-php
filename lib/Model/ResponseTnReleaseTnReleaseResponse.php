...
/**
 * ResponseTnReleaseTnReleaseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnReleaseTnReleaseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnRelease_tnReleaseResponse';
    ...
    protected static $openAPITypes = [
        'total_tn_count' => 'int',
        'released_tn_count' => 'int',
        'excluded_tn_list' => '\OpenAPI\Client\Model\ResponseTnReserveTnReserveResponseExcludedTnList[]'
    ];
    ...
    protected static $openAPIFormats = [
        'total_tn_count' => null,
        'released_tn_count' => null,
        'excluded_tn_list' => null
    ];
    ...
    protected static $attributeMap = [
        'total_tn_count' => 'totalTnCount',
        'released_tn_count' => 'releasedTnCount',
        'excluded_tn_list' => 'excludedTnList'
    ];
    ...
    protected static $setters = [
        'total_tn_count' => 'setTotalTnCount',
        'released_tn_count' => 'setReleasedTnCount',
        'excluded_tn_list' => 'setExcludedTnList'
    ];
    ...
    protected static $getters = [
        'total_tn_count' => 'getTotalTnCount',
        'released_tn_count' => 'getReleasedTnCount',
        'excluded_tn_list' => 'getExcludedTnList'
    ];
    ...
    {
        $this->container['total_tn_count'] = $data['total_tn_count'] ?? null;
        $this->container['released_tn_count'] = $data['released_tn_count'] ?? null;
        $this->container['excluded_tn_list'] = $data['excluded_tn_list'] ?? null;
    }
     ...
     * @return int|null
     */
    public function getTotalTnCount()
    {
        return $this->container['total_tn_count'];
    }

    /**
     * Sets total_tn_count
     *
     * @param int|null $total_tn_count Total requested TN count
     *
     * @return self
     */
    public function setTotalTnCount($total_tn_count)
    {
        $this->container['total_tn_count'] = $total_tn_count;

        return $this;
    }

    /**
     * Gets released_tn_count
     *
     * @return int|null
     */
    public function getReleasedTnCount()
    {
        return $this->container['released_tn_count'];
    }

    /**
     * Sets released_tn_count
     *
     * @param int|null $released_tn_count Successfully released TN count
     *
     * @return self
     */
    public function setReleasedTnCount($released_tn_count)
    {
        $this->container['released_tn_count'] = $released_tn_count;

        return $this;
    }

    /**
     * Gets excluded_tn_list
     *
     * @return \OpenAPI\Client\Model\ResponseTnReserveTnReserveResponseExcludedTnList[]|null
     */
    public function getExcludedTnList()
    {
        return $this->container['excluded_tn_list'];
    }

    /**
     * Sets excluded_tn_list
     *
     * @param \OpenAPI\Client\Model\ResponseTnReserveTnReserveResponseExcludedTnList[]|null $excluded_tn_list excluded_tn_list
     *
     * @return self
     */
    public function setExcludedTnList($excluded_tn_list)
    {
        $this->container['excluded_tn_list'] = $excluded_tn_list;
