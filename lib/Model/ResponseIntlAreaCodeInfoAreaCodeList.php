<?php
/**
 * ResponseIntlAreaCodeInfoAreaCodeList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseIntlAreaCodeInfoAreaCodeList Class Doc Comment
 *
 * @category Class
 * @description Encompassing object that holds areacode info
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseIntlAreaCodeInfoAreaCodeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlAreaCodeInfo_areaCodeList';
     ...
     * Sets country_ref
     *
     * @param string|null $country_ref country Ref
     *
     * @return self
     */
     ...
     * Sets area_code
     *
     * @param string|null $area_code area Code
     *
     * @return self
     */
