...
/**
 * InlineResponse41428 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41428 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_28';
     ...
     * Sets status
     *
     * @param string|null $status Fields Required are missing | Fields Are Required:(All Required Fields) | Invalid value entered for:(Input Fields
     *
     * @return self
     */
