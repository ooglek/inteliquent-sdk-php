...
/**
 * TnOrderTnOrderForecast Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnOrderTnOrderForecast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnOrder_tnOrder_forecast';
    ...
    protected static $openAPITypes = [
        'lata_item' => '\OpenAPI\Client\Model\TnOrderTnOrderForecastLataItem[]'
    ];
    ...
    {
        $this->container['lata_item'] = $data['lata_item'] ?? null;
    }
     ...
     * Gets lata_item
     *
     * @return \OpenAPI\Client\Model\TnOrderTnOrderForecastLataItem[]|null
     */
    public function getLataItem()
    {
        return $this->container['lata_item'];
    }

    /**
     * Sets lata_item
     *
     * @param \OpenAPI\Client\Model\TnOrderTnOrderForecastLataItem[]|null $lata_item lata_item
     *
     * @return self
     */
    public function setLataItem($lata_item)
    {
        $this->container['lata_item'] = $lata_item;
