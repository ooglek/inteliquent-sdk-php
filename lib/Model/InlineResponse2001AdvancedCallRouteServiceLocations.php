<?php
/**
 * InlineResponse2001AdvancedCallRouteServiceLocations
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse2001AdvancedCallRouteServiceLocations Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse2001AdvancedCallRouteServiceLocations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_1_advancedCallRouteServiceLocations';
    ...
    protected static $attributeMap = [
        'service_area_ref' => 'serviceAreaRef',
        'state' => 'state',
        'name' => 'name'
    ];
    ...
    protected static $setters = [
        'service_area_ref' => 'setServiceAreaRef',
        'state' => 'setState',
        'name' => 'setName'
    ];
    ...
    protected static $getters = [
        'service_area_ref' => 'getServiceAreaRef',
        'state' => 'getState',
        'name' => 'getName'
    ];
    ...
    {
        $this->container['service_area_ref'] = $data['service_area_ref'] ?? null;
    ...
    /**
     * Gets service_area_ref
     *
     * @return string|null
     */
    public function getServiceAreaRef()
    {
        return $this->container['service_area_ref'];
    }

    /**
     * Sets service_area_ref
     *
     * @param string|null $service_area_ref Reference for service area
     *
     * @return self
     */
    public function setServiceAreaRef($service_area_ref)
    {
        $this->container['service_area_ref'] = $service_area_ref;
     ...
     * Sets state
     *
     * @param string|null $state 2 letter code for the location
     *
     * @return self
     */
