<?php
/**
 * TrunkGroupOrderTrunkGroupOrderCodecListCodecItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderTrunkGroupOrderCodecListCodecItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrunkGroupOrderTrunkGroupOrderCodecListCodecItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_trunkGroupOrder_trunkGroupOrder_codecList_codecItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dtmf_relay'] === null) {
            $invalidProperties[] = "'dtmf_relay' can't be null";
        }
     ...
     * Sets dtmf_relay
     *
     * @param string $dtmf_relay DTMF Relay
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param int $percentage Codec Percentage
     *
     * @return self
     */
     ...
     * Sets priority
     *
     * @param int $priority Codec Priority
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Action like Add
     *
     * @return self
     */
