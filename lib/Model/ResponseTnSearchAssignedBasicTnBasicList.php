<?php
/**
 * ResponseTnSearchAssignedBasicTnBasicList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTnSearchAssignedBasicTnBasicList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnSearchAssignedBasicTnBasicList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnSearchAssignedBasic_tnBasicList';
    ...
    protected static $openAPITypes = [
        'tn_basic_item' => '\OpenAPI\Client\Model\ResponseTnSearchAssignedBasicTnBasicListTnBasicItem[]'
    ];
    ...
    {
        $this->container['tn_basic_item'] = $data['tn_basic_item'] ?? null;
    }
     ...
     * Gets tn_basic_item
     *
     * @return \OpenAPI\Client\Model\ResponseTnSearchAssignedBasicTnBasicListTnBasicItem[]|null
     */
    public function getTnBasicItem()
    {
        return $this->container['tn_basic_item'];
    }

    /**
     * Sets tn_basic_item
     *
     * @param \OpenAPI\Client\Model\ResponseTnSearchAssignedBasicTnBasicListTnBasicItem[]|null $tn_basic_item tn_basic_item
     *
     * @return self
     */
    public function setTnBasicItem($tn_basic_item)
    {
        $this->container['tn_basic_item'] = $tn_basic_item;
