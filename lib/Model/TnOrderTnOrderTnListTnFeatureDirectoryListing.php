<?php
/**
 * TnOrderTnOrderTnListTnFeatureDirectoryListing
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnOrderTnOrderTnListTnFeatureDirectoryListing Class Doc Comment
 *
 * @category Class
 ...
 */
class TnOrderTnOrderTnListTnFeatureDirectoryListing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnOrder_tnOrder_tnList_tnFeature_directoryListing';
     ...
     * Sets cancel_feature
     *
     * @param string|null $cancel_feature Enter Y to cancel a request to add directory listing information to the telephone number
     *
     * @return self
     */
