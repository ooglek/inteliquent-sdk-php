<?php
/**
 * BrandOrderListOrderListOrderType
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * BrandOrderListOrderListOrderType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BrandOrderListOrderListOrderType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandOrderList_orderList_orderType';
     ...
     * Sets created_date
     *
     * @param string|null $created_date Date the Order was created
     *
     * @return self
     */
