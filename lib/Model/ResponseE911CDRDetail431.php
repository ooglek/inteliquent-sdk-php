...
/**
 * ResponseE911CDRDetail431 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseE911CDRDetail431 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseE911CDRDetail431';
     ...
     * Sets status
     *
     * @param string|null $status Unable to complete the request at the moment, please try again
     *
     * @return self
     */
