...
/**
 * InlineResponse4172 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4172 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_417_2';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 417
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status No voice scripts found for requested data.
     *
     * @return self
     */
