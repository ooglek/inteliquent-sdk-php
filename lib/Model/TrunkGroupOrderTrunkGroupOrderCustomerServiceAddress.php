<?php
/**
 * TrunkGroupOrderTrunkGroupOrderCustomerServiceAddress
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderTrunkGroupOrderCustomerServiceAddress Class Doc Comment
 *
 * @category Class
 * @description Contains Customer Service Address Details
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TrunkGroupOrderTrunkGroupOrderCustomerServiceAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_trunkGroupOrder_trunkGroupOrder_customerServiceAddress';
     ...
     *
     * @param string|null $use_billing_tax_location Y/N flag. if Y entered then no need to enter address details
     *
     * @return self
     */
