<?php
/**
 * ResponseTrunkGroupListTrunkGroupList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTrunkGroupListTrunkGroupList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTrunkGroupListTrunkGroupList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTrunkGroupList_trunkGroupList';
     ...
     * Sets status
     *
     * @param string|null $status Trunk group status
     *
     * @return self
     */
