<?php
/**
 * MessageCampaignsMessageCampaignListMessageCampaignItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * MessageCampaignsMessageCampaignListMessageCampaignItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessageCampaignsMessageCampaignListMessageCampaignItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageCampaigns_messageCampaignList_messageCampaignItem';
    ...
    protected static $setters = [
        'msg_campaign_id' => 'setMsgCampaignId',
    ...
    protected static $getters = [
        'msg_campaign_id' => 'getMsgCampaignId',
    ...
    {
        $this->container['msg_campaign_id'] = $data['msg_campaign_id'] ?? null;
    ...
    /**
     * Gets msg_campaign_id
     *
     * @return string|null
     */
    public function getMsgCampaignId()
    {
        return $this->container['msg_campaign_id'];
    }

    /**
     * Sets msg_campaign_id
     *
     * @param string|null $msg_campaign_id Messaging Campaign Id
     *
     * @return self
     */
    public function setMsgCampaignId($msg_campaign_id)
    {
        $this->container['msg_campaign_id'] = $msg_campaign_id;
     ...
     * Sets description
     *
     * @param string|null $description Messaging Campaign Description
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param string|null $start_date Messaging Campaign Start Date
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param string|null $end_date Messaging Campaign End Date
     *
     * @return self
     */
     ...
     * Sets is_billable
     *
     * @param string|null $is_billable Messaging Campaign isBillable
     *
     * @return self
     */
     ...
     *
     * @param string|null $is_dca_approved Is the campaign DCA Approved?
     *
     * @return self
     */
