<?php
/**
 * TrunkGroupUpdateEnterpriseCustomerAccount
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupUpdateEnterpriseCustomerAccount Class Doc Comment
 *
 * @category Class
 * @description External Identifier for trunk group
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TrunkGroupUpdateEnterpriseCustomerAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_trunkGroupUpdate_enterpriseCustomerAccount';
     ...
     * @return string[]
     */
    public function getRemoveAllowableValues()
    {
        return [
            self::REMOVE_Y,
            self::REMOVE_N,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getRemoveAllowableValues();
        if (!is_null($this->container['remove']) && !in_array($this->container['remove'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'remove', must be one of '%s'",
     ...
     * Sets identity
     *
     * @param string|null $identity enterprise customer account identity
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name enterprise customer account name
     *
     * @return self
     */
     ...
     * Sets remove
     *
     * @param string|null $remove flag to add or remove enterprise customer account. Acceptable values are Y and N
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getRemoveAllowableValues();
        if (!is_null($remove) && !in_array($remove, $allowedValues, true)) {
