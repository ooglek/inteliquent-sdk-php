...
/**
 * CampaignDetailCampaignDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignDetailCampaignDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignDetail_campaignDetail';
    ...
    protected static $openAPITypes = [
        ...
        'is_pooled' => 'string',
        'is_billable_count' => 'string',
        'tn_assigned_count' => 'int',
    ...
    protected static $openAPIFormats = [
        ...
        'is_pooled' => null,
        'is_billable_count' => null,
        'tn_assigned_count' => null,
    ...
    protected static $attributeMap = [
        ...
        'is_pooled' => 'isPooled',
        'is_billable_count' => 'isBillableCount',
        'tn_assigned_count' => 'tnAssignedCount',
    ...
    protected static $setters = [
        ...
        'external_brand_id' => 'setExternalBrandId',
        'is_dca_approved' => 'setIsDcaApproved',
        'is_pooled' => 'setIsPooled',
        'is_billable_count' => 'setIsBillableCount',
        'tn_assigned_count' => 'setTnAssignedCount',
    ...
    protected static $getters = [
        ...
        'external_brand_id' => 'getExternalBrandId',
        'is_dca_approved' => 'getIsDcaApproved',
        'is_pooled' => 'getIsPooled',
        'is_billable_count' => 'getIsBillableCount',
        'tn_assigned_count' => 'getTnAssignedCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['external_brand_id'] = $data['external_brand_id'] ?? null;
        $this->container['is_dca_approved'] = $data['is_dca_approved'] ?? null;
        $this->container['is_pooled'] = $data['is_pooled'] ?? null;
        $this->container['is_billable_count'] = $data['is_billable_count'] ?? null;
        $this->container['tn_assigned_count'] = $data['tn_assigned_count'] ?? null;
     ...
     *
     * @param string|null $external_campaign_id Campaign Id
     *
     * @return self
     */
    ...
    /**
     * Gets external_brand_id
     *
     * @return string|null
     */
    public function getExternalBrandId()
    {
        return $this->container['external_brand_id'];
    }

    /**
     * Sets external_brand_id
     *
     * @param string|null $external_brand_id Brand Id
     *
     * @return self
     */
    public function setExternalBrandId($external_brand_id)
    {
        $this->container['external_brand_id'] = $external_brand_id;
     ...
     *
     * @param string|null $is_dca_approved DCA approval flag
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getIsPooled()
    {
        return $this->container['is_pooled'];
    }

    /**
     * Sets is_pooled
     *
     * @param string|null $is_pooled Pooling flag
     *
     * @return self
     */
    public function setIsPooled($is_pooled)
    {
        $this->container['is_pooled'] = $is_pooled;

        return $this;
    }

    /**
     * Gets is_billable_count
     *
     * @return string|null
     */
    public function getIsBillableCount()
    {
        return $this->container['is_billable_count'];
    }

    /**
     * Sets is_billable_count
     *
     * @param string|null $is_billable_count Billable flag
     *
     * @return self
     */
    public function setIsBillableCount($is_billable_count)
    {
        $this->container['is_billable_count'] = $is_billable_count;

        return $this;
    }

    /**
     * Gets tn_assigned_count
     *
     * @return int|null
     */
    public function getTnAssignedCount()
    {
        return $this->container['tn_assigned_count'];
    }

    /**
     * Sets tn_assigned_count
     *
     * @param int|null $tn_assigned_count Count of TN assigned to campaign
     *
     * @return self
     */
    public function setTnAssignedCount($tn_assigned_count)
    {
        $this->container['tn_assigned_count'] = $tn_assigned_count;
     ...
     *
     * @param string|null $campaign_start_date Campaign start date. Format:- YYYY-MM-DD
     *
     * @return self
     */
     ...
     *
     * @param string|null $campaign_end_date Campaign end date. Format:- YYYY-MM-DD
     *
     * @return self
     */
     ...
     *
     * @param string|null $campaign_description Campaign description
     *
     * @return self
     */
