...
/**
 * InlineResponse41436 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41436 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_36';
     ...
     * Sets status
     *
     * @param string|null $status Error text listing the actual error that occured | Fields Are Required:(All Required Fields) | Invalid value entered for:(Input Fields) |  TrunkGroup Session Update is not allowed for customer
     *
     * @return self
     */
