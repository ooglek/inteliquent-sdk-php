...
/**
 * InlineResponse4173 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4173 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_417_3';
     ...
     * Sets status
     *
     * @param string|null $status Quantity must be at least 1000
     *
     * @return self
     */
