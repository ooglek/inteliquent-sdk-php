...
class InlineResponse4091 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status CustomerOrderReference has invalid characters and cannot include <, \\\\, ^, ~, `, }, {, >, =, ], [, ! | Invalid Input Parameters:sortDirection can be either ASC or DESC
     *
     * @return self
     */
