...
/**
 * ResponseOrderDetailOrderDetailResponseTnListCicCompanyList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseOrderDetailOrderDetailResponseTnListCicCompanyList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseOrderDetail_orderDetailResponse_tnList_cicCompanyList';
    ...
    {
        $this->container['cic_company'] = $data['cic_company'] ?? null;
    }
     ...
     * @return string[]|null
     */
    public function getCicCompany()
    {
        return $this->container['cic_company'];
    }

    /**
     * Sets cic_company
     *
     * @param string[]|null $cic_company cic_company
     *
     * @return self
     */
    public function setCicCompany($cic_company)
    {
        $this->container['cic_company'] = $cic_company;
