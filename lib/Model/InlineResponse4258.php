...
/**
 * InlineResponse4258 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4258 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_425_8';
     ...
     * Sets status
     *
     * @param string|null $status Error Message:(String) | Error Message:(Error String)
     *
     * @return self
     */
