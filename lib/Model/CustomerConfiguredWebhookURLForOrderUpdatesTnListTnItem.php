<?php
/**
 * CustomerConfiguredWebhookURLForOrderUpdatesTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CustomerConfiguredWebhookURLForOrderUpdatesTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerConfiguredWebhookURLForOrderUpdatesTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_customerConfiguredWebhookURLForOrderUpdates_tnList_tnItem';
    ...
    protected static $openAPITypes = [
        ...
        'port_out_pin' => 'string',
        'auth_name' => 'string',
        'end_user' => '\OpenAPI\Client\Model\CustomerConfiguredWebhookURLForOrderUpdatesTnListEndUser'
    ];
     ...
     * Gets end_user
     *
     * @return \OpenAPI\Client\Model\CustomerConfiguredWebhookURLForOrderUpdatesTnListEndUser|null
     */
     ...
     * Sets end_user
     *
     * @param \OpenAPI\Client\Model\CustomerConfiguredWebhookURLForOrderUpdatesTnListEndUser|null $end_user end_user
     *
     * @return self
     */
