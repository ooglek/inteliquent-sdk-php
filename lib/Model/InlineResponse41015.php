...
/**
 * InlineResponse41015 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41015 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410_15';
     ...
     * Sets status
     *
     * @param string|null $status DB Error:(Database Error) |  Invalid Request
     *
     * @return self
     */
