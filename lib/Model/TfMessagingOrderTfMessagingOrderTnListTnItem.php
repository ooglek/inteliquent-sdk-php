<?php
/**
 * TfMessagingOrderTfMessagingOrderTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TfMessagingOrderTfMessagingOrderTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfMessagingOrderTfMessagingOrderTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfMessagingOrder_tfMessagingOrder_tnList_tnItem';
    ...
    protected static $openAPITypes = [
        'tn' => 'string',
        'tn_note' => 'string',
        'tn_feature' => '\OpenAPI\Client\Model\TfMessagingOrderTfMessagingOrderTnListTnFeature'
    ];
     ...
     * Sets tn_note
     *
     * @param string|null $tn_note Note text to apply to the number
     *
     * @return self
     */
     ...
     * Gets tn_feature
     *
     * @return \OpenAPI\Client\Model\TfMessagingOrderTfMessagingOrderTnListTnFeature|null
     */
     ...
     * Sets tn_feature
     *
     * @param \OpenAPI\Client\Model\TfMessagingOrderTfMessagingOrderTnListTnFeature|null $tn_feature tn_feature
     *
     * @return self
     */
