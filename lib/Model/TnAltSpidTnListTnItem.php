...
/**
 * TnAltSpidTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnAltSpidTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnAltSpid_tnList_tnItem';
    ...
    const REMOVE_ALT_SPID_Y = 'Y';
    const REMOVE_ALT_SPID_N = 'N';
     ...
     * @return string[]
     */
    public function getRemoveAltSpidAllowableValues()
    {
        return [
            self::REMOVE_ALT_SPID_Y,
            self::REMOVE_ALT_SPID_N,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['alt_spid'] === null) {
            $invalidProperties[] = "'alt_spid' can't be null";
        }
        $allowedValues = $this->getRemoveAltSpidAllowableValues();
        if (!is_null($this->container['remove_alt_spid']) && !in_array($this->container['remove_alt_spid'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'remove_alt_spid', must be one of '%s'",
                $this->container['remove_alt_spid'],
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number to change alternative spid (e.g. 8156680000)
     *
     * @return self
     */
     ...
     * Sets alt_spid
     *
     * @param string $alt_spid Alternate SPID (e.g. 8156680000)
     *
     * @return self
     */
     ...
     *
     * @param string|null $remove_alt_spid add or remove alternative SPID for the Tn Number; acceptable values are Y and N
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getRemoveAltSpidAllowableValues();
        if (!is_null($remove_alt_spid) && !in_array($remove_alt_spid, $allowedValues, true)) {
