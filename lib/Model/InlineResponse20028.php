...
class InlineResponse20028 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'string',
        'status' => 'string',
        'tn_forward_list' => '\OpenAPI\Client\Model\InlineResponse20028TnForwardList[]'
    ];
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'tn_forward_list' => 'setTnForwardList'
    ];
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'tn_forward_list' => 'getTnForwardList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tn_forward_list'] = $data['tn_forward_list'] ?? null;
    }
    ...
    /**
     * Gets tn_forward_list
     *
     * @return \OpenAPI\Client\Model\InlineResponse20028TnForwardList[]|null
     */
    public function getTnForwardList()
    {
        return $this->container['tn_forward_list'];
    }

    /**
     * Sets tn_forward_list
     *
     * @param \OpenAPI\Client\Model\InlineResponse20028TnForwardList[]|null $tn_forward_list Contains list of  telephone number(s) with forwardTo
     *
     * @return self
     */
    public function setTnForwardList($tn_forward_list)
    {
        $this->container['tn_forward_list'] = $tn_forward_list;
