...
/**
 * TfOrderTfOrderTnListCicList Class Doc Comment
 *
 * @category Class
 * @description Contains CIC(s) for the toll free number
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TfOrderTfOrderTnListCicList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfOrder_tfOrder_tnList_cicList';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cic'] === null) {
            $invalidProperties[] = "'cic' can't be null";
        }
