<?php
/**
 * TrunkGroupOrderTrunkGroupOrderTrunkGroupFeature
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderTrunkGroupOrderTrunkGroupFeature Class Doc Comment
 *
 * @category Class
 ...
 */
class TrunkGroupOrderTrunkGroupOrderTrunkGroupFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_trunkGroupOrder_trunkGroupOrder_trunkGroupFeature';
    ...
    {
        $this->container['enable911'] = $data['enable911'] ?? null;
    }
     ...
     * @return string|null
     */
    public function getEnable911()
    {
        return $this->container['enable911'];
    }

    /**
     * Sets enable911
     *
     * @param string|null $enable911 Enable E911
     *
     * @return self
     */
    public function setEnable911($enable911)
    {
        $this->container['enable911'] = $enable911;
