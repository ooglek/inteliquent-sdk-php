<?php
/**
 * ResponseAvailableActivationListAvailableActivationList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseAvailableActivationListAvailableActivationList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseAvailableActivationListAvailableActivationList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAvailableActivationList_availableActivationList';
    ...
    protected static $openAPITypes = [
        'tn_group' => 'string',
        'foc_dt' => 'string',
        'tn_list' => '\OpenAPI\Client\Model\ResponseAvailableActivationListTnList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['foc_dt'] = $data['foc_dt'] ?? null;
     ...
     * @return string|null
     */
    public function getFocDt()
    {
        return $this->container['foc_dt'];
    }

    /**
     * Sets foc_dt
     *
     * @param string|null $foc_dt foc_dt
     *
     * @return self
     */
    public function setFocDt($foc_dt)
    {
        $this->container['foc_dt'] = $foc_dt;
     ...
     * Gets tn_list
     *
     * @return \OpenAPI\Client\Model\ResponseAvailableActivationListTnList|null
     */
     ...
     * Sets tn_list
     *
     * @param \OpenAPI\Client\Model\ResponseAvailableActivationListTnList|null $tn_list tn_list
     *
     * @return self
     */
