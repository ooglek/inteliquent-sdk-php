<?php
/**
 * ResponseTnFeatureCnamDipListTnFeatureCnamDipList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTnFeatureCnamDipListTnFeatureCnamDipList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnFeatureCnamDipListTnFeatureCnamDipList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnFeatureCnamDipList_tnFeatureCnamDipList';
     ...
     * Sets cnam_dip
     *
     * @param string|null $cnam_dip it will return  Y if cnamDip enabled, else N.
     *
     * @return self
     */
