<?php
/**
 * CampaignOrderListOrderListOrderType
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CampaignOrderListOrderListOrderType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignOrderListOrderListOrderType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignOrderList_orderList_orderType';
     ...
     *
     * @param string|null $customer_order_reference Order Status
     *
     * @return self
     */
