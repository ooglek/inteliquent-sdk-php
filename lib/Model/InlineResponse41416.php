...
/**
 * InlineResponse41416 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41416 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_16';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | tnNote must not exceed 4000 characters for TN/s
     *
     * @return self
     */
