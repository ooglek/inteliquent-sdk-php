...
/**
 * InlineResponse40822 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40822 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_408_22';
     ...
     * Sets status
     *
     * @param string|null $status orderId can not be blank.  | Private Key cannot be blank.
     *
     * @return self
     */
