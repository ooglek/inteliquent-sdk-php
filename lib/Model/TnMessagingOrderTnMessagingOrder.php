<?php
/**
 * TnMessagingOrderTnMessagingOrder
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnMessagingOrderTnMessagingOrder Class Doc Comment
 *
 * @category Class
 ...
 */
class TnMessagingOrderTnMessagingOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnMessagingOrder_tnMessagingOrder';
    ...
    protected static $openAPITypes = [
        ...
        'loa' => 'string',
        'tn_list' => '\OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['loa'] = $data['loa'] ?? null;
    ...
    {
        return $this->container['loa'];
    }

    /**
     * Sets loa
     *
     * @param string|null $loa Indicates that LOA is obtained to enable Inteliquent messaging service on telephone numbers voice-enabled with another carrier; acceptable value is Y
     *
     * @return self
     */
    public function setLoa($loa)
    {
        $this->container['loa'] = $loa;
     ...
     * Gets tn_list
     *
     * @return \OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnList
     */
     ...
     * Sets tn_list
     *
     * @param \OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnList $tn_list tn_list
     *
     * @return self
     */
