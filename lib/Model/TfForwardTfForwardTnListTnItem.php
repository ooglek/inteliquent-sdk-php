<?php
/**
 * TfForwardTfForwardTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TfForwardTfForwardTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfForwardTfForwardTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfForward_tfForward_tnList_tnItem';
    ...
    protected static $attributeMap = [
        ...
        'remove_forward_to' => 'removeForwardTo'
    ];
    ...
    protected static $setters = [
        ...
        'remove_forward_to' => 'setRemoveForwardTo'
    ];
    ...
    protected static $getters = [
        ...
        'remove_forward_to' => 'getRemoveForwardTo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['remove_forward_to'] = $data['remove_forward_to'] ?? null;
    }
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit toll free number to which the forwarding needs to be applied (e.g. 8556680000).
     *
     * @return self
     */
     ...
     * Sets forward_to
     *
     * @param string|null $forward_to Ten-digit telephone number to which the forwarding needs to be applied (e.g. 3156680000). Either ForwardTo or removeForwardTo needs to be specified.
     *
     * @return self
     */
    ...
    /**
     * Gets remove_forward_to
     *
     * @return string|null
     */
    public function getRemoveForwardTo()
    {
        return $this->container['remove_forward_to'];
    }

    /**
     * Sets remove_forward_to
     *
     * @param string|null $remove_forward_to If you want to remove the forwarding associated with the given TN, then pass this flag with a value of \"Y\". Either ForwardTo or removeForwardTo needs to be specified.
     *
     * @return self
     */
    public function setRemoveForwardTo($remove_forward_to)
    {
        $this->container['remove_forward_to'] = $remove_forward_to;
