...
/**
 * InlineResponse4105 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4105 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410_5';
     ...
     * Sets status
     *
     * @param string|null $status Primary private key is required | Required fields not sent | Private key is required
     *
     * @return self
     */
