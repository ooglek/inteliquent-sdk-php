<?php
/**
 * PortInOrderListOrderListFocList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PortInOrderListOrderListFocList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInOrderListOrderListFocList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInOrderList_orderList_focList';
    ...
    protected static $openAPITypes = [
        'foc_item' => '\OpenAPI\Client\Model\PortInOrderListOrderListFocListFocItem[]'
    ];
    ...
    {
        $this->container['foc_item'] = $data['foc_item'] ?? null;
    }
     ...
     * Gets foc_item
     *
     * @return \OpenAPI\Client\Model\PortInOrderListOrderListFocListFocItem[]|null
     */
    public function getFocItem()
    {
        return $this->container['foc_item'];
    }

    /**
     * Sets foc_item
     *
     * @param \OpenAPI\Client\Model\PortInOrderListOrderListFocListFocItem[]|null $foc_item foc_item
     *
     * @return self
     */
    public function setFocItem($foc_item)
    {
        $this->container['foc_item'] = $foc_item;
