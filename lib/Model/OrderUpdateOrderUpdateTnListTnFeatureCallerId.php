...
/**
 * OrderUpdateOrderUpdateTnListTnFeatureCallerId Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderUpdateOrderUpdateTnListTnFeatureCallerId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orderUpdate_orderUpdate_tnList_tnFeature_callerId';
     ...
     *
     * @param string|null $cancel_feature_request Enter Y to cancel a request to add caller ID information to the telephone number
     *
     * @return self
     */
