<?php
/**
 * ResponseTfInventoryTfListTfItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTfInventoryTfListTfItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTfInventoryTfListTfItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTfInventory_tfList_tfItem';
     ...
     * Sets tn
     *
     * @param string|null $tn toll free number
     *
     * @return self
     */
