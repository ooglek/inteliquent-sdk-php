...
/**
 * InlineResponse4147 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4147 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_7';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required |  Large result set without searchId detected. Please contact support team for assistance.
     *
     * @return self
     */
