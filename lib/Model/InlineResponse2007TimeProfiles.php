...
/**
 * InlineResponse2007TimeProfiles Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse2007TimeProfiles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_7_timeProfiles';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['time_zone_ref'] = $data['time_zone_ref'] ?? null;
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone Name of the time zone
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getTimeZoneRef()
    {
        return $this->container['time_zone_ref'];
    }

    /**
     * Sets time_zone_ref
     *
     * @param string|null $time_zone_ref Reference for time zone
     *
     * @return self
     */
    public function setTimeZoneRef($time_zone_ref)
    {
        $this->container['time_zone_ref'] = $time_zone_ref;
     ...
     * Sets status
     *
     * @param string|null $status Status of time profile
     *
     * @return self
     */
