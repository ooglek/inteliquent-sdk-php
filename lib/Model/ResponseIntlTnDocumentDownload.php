...
/**
 * ResponseIntlTnDocumentDownload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseIntlTnDocumentDownload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlTnDocumentDownload';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'document' => '\OpenAPI\Client\Model\ResponseIntlTnDocumentDownloadDocument'
    ];
     ...
     * Gets document
     *
     * @return \OpenAPI\Client\Model\ResponseIntlTnDocumentDownloadDocument|null
     */
     ...
     * Sets document
     *
     * @param \OpenAPI\Client\Model\ResponseIntlTnDocumentDownloadDocument|null $document document
     *
     * @return self
     */
