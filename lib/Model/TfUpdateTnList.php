...
/**
 * TfUpdateTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active toll free number(s) to update
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TfUpdateTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfUpdate_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TfUpdateTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TfUpdateTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TfUpdateTnListTnItem[]|null $tn_item Contains active toll free number(s) to update
     *
     * @return self
     */
