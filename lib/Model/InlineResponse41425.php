...
/**
 * InlineResponse41425 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41425 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_25';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) |  Invalid value entered for
     *
     * @return self
     */
