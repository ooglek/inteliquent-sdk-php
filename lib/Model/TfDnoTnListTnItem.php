...
/**
 * TfDnoTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfDnoTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfDno_tnList_tnItem';
     ...
     * Sets dno
     *
     * @param string|null $dno Should be set to 'Y' to enable dno for toll free number. Acceptable values are Y and N
     *
     * @return self
     */
