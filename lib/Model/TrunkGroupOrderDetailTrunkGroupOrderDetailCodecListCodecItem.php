<?php
/**
 * TrunkGroupOrderDetailTrunkGroupOrderDetailCodecListCodecItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderDetailTrunkGroupOrderDetailCodecListCodecItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrunkGroupOrderDetailTrunkGroupOrderDetailCodecListCodecItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrunkGroupOrderDetail_trunkGroupOrderDetail_codecList_codecItem';
    ...
    protected static $openAPITypes = [
        ...
        'packet_size' => 'int',
        'priority' => 'int',
        'fax_tone_treatment' => 'string',
        'modem_tone_treatment' => 'string',
        'dtmf_relay' => 'string',
        'silent_suppression' => 'string',
        'percentage' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'packet_size' => null,
        'priority' => null,
        'fax_tone_treatment' => null,
        'modem_tone_treatment' => null,
        'dtmf_relay' => null,
        'silent_suppression' => null,
        'percentage' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'priority' => 'priority',
        'fax_tone_treatment' => 'faxToneTreatment',
        'modem_tone_treatment' => 'modemToneTreatment',
        'dtmf_relay' => 'dtmfRelay',
    ...
    protected static $setters = [
        ...
        'fax_tone_treatment' => 'setFaxToneTreatment',
        'modem_tone_treatment' => 'setModemToneTreatment',
        'dtmf_relay' => 'setDtmfRelay',
        'silent_suppression' => 'setSilentSuppression',
    ...
    protected static $getters = [
        ...
        'fax_tone_treatment' => 'getFaxToneTreatment',
        'modem_tone_treatment' => 'getModemToneTreatment',
        'dtmf_relay' => 'getDtmfRelay',
        'silent_suppression' => 'getSilentSuppression',
    ...
    {
        $this->container['codec'] = $data['codec'] ?? null;
        $this->container['packet_size'] = $data['packet_size'] ?? null;
        $this->container['priority'] = $data['priority'] ?? null;
        $this->container['fax_tone_treatment'] = $data['fax_tone_treatment'] ?? null;
        $this->container['modem_tone_treatment'] = $data['modem_tone_treatment'] ?? null;
        $this->container['dtmf_relay'] = $data['dtmf_relay'] ?? null;
        $this->container['silent_suppression'] = $data['silent_suppression'] ?? null;
     ...
     * Sets codec
     *
     * @param string|null $codec Codec Name
     *
     * @return self
     */
     ...
     * Sets packet_size
     *
     * @param int|null $packet_size Codec Packet Size
     *
     * @return self
     */
     ...
     * Sets priority
     *
     * @param int|null $priority Codec Priority
     *
     * @return self
     */
    ...
    /**
     * Gets fax_tone_treatment
     *
     * @return string|null
     */
    public function getFaxToneTreatment()
    {
        return $this->container['fax_tone_treatment'];
    }

    /**
     * Sets fax_tone_treatment
     *
     * @param string|null $fax_tone_treatment Fax Tone Treatment
     *
     * @return self
     */
    public function setFaxToneTreatment($fax_tone_treatment)
    {
        $this->container['fax_tone_treatment'] = $fax_tone_treatment;

        return $this;
    }

    /**
     * Gets modem_tone_treatment
     *
     * @return string|null
     */
    public function getModemToneTreatment()
    {
        return $this->container['modem_tone_treatment'];
    }

    /**
     * Sets modem_tone_treatment
     *
     * @param string|null $modem_tone_treatment Modem Tone Treatment
     *
     * @return self
     */
    public function setModemToneTreatment($modem_tone_treatment)
    {
        $this->container['modem_tone_treatment'] = $modem_tone_treatment;
     ...
     * @return string|null
     */
    public function getDtmfRelay()
    {
        return $this->container['dtmf_relay'];
    }

    /**
     * Sets dtmf_relay
     *
     * @param string|null $dtmf_relay DTMF Relay
     *
     * @return self
     */
    public function setDtmfRelay($dtmf_relay)
    {
        $this->container['dtmf_relay'] = $dtmf_relay;

        return $this;
    }

    /**
     * Gets silent_suppression
     *
     * @return string|null
     */
    public function getSilentSuppression()
    {
        return $this->container['silent_suppression'];
    }

    /**
     * Sets silent_suppression
     *
     * @param string|null $silent_suppression Y/N flag for Silent Suppression
     *
     * @return self
     */
    public function setSilentSuppression($silent_suppression)
    {
        $this->container['silent_suppression'] = $silent_suppression;
     ...
     * Sets percentage
     *
     * @param int|null $percentage Codec Usage Percentage
     *
     * @return self
     */
