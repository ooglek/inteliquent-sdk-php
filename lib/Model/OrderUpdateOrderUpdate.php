...
/**
 * OrderUpdateOrderUpdate Class Doc Comment
 *
 * @category Class
 * @description Contains updated order information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OrderUpdateOrderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orderUpdate_orderUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'tn_list' => '\OpenAPI\Client\Model\OrderUpdateOrderUpdateTnList'
    ];
     ...
     *
     * @param string|null $desired_due_date New desired due date for the order (e.g. 2015-12-15)
     *
     * @return self
     */
     ...
     *
     * @param string|null $desired_port_time New desired port time in HH:MM (e.g. 14:00)
     *
     * @return self
     */
     ...
     *
     * @param string|null $on_demand_activation Acceptable values are Y and N
     *
     * @return self
     */
     ...
     * Sets reseller_name
     *
     * @param string|null $reseller_name Reseller Name (Loosing Carrier) can be updated for PortIn Orders (Canadian Port Requests)
     *
     * @return self
     */
     ...
     * Gets tn_list
     *
     * @return \OpenAPI\Client\Model\OrderUpdateOrderUpdateTnList|null
     */
     ...
     * Sets tn_list
     *
     * @param \OpenAPI\Client\Model\OrderUpdateOrderUpdateTnList|null $tn_list tn_list
     *
     * @return self
     */
