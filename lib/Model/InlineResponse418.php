...
/**
 * InlineResponse418 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse418 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_418';
     ...
     * Sets status
     *
     * @param string|null $status Character limit is exceeded for:(All String Fields)
     *
     * @return self
     */
