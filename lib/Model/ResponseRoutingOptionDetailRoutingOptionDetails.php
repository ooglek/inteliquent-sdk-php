<?php
/**
 * ResponseRoutingOptionDetailRoutingOptionDetails
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseRoutingOptionDetailRoutingOptionDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseRoutingOptionDetailRoutingOptionDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRoutingOptionDetail_routingOptionDetails';
    ...
    protected static $openAPITypes = [
        ...
        'routing_product_types' => '\OpenAPI\Client\Model\ResponseRoutingOptionDetailRoutingProductTypes[]',
        'routing_trunk_groups' => '\OpenAPI\Client\Model\ResponseRoutingOptionDetailRoutingTrunkGroups[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'routing_product_types' => null,
        'routing_trunk_groups' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'routing_product_types' => 'routingProductTypes',
        'routing_trunk_groups' => 'routingTrunkGroups'
    ];
    ...
    protected static $setters = [
        ...
        'routing_product_types' => 'setRoutingProductTypes',
        'routing_trunk_groups' => 'setRoutingTrunkGroups'
    ];
    ...
    protected static $getters = [
        ...
        'routing_product_types' => 'getRoutingProductTypes',
        'routing_trunk_groups' => 'getRoutingTrunkGroups'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['routing_product_types'] = $data['routing_product_types'] ?? null;
        $this->container['routing_trunk_groups'] = $data['routing_trunk_groups'] ?? null;
    }
    ...
    /**
     * Gets routing_product_types
     *
     * @return \OpenAPI\Client\Model\ResponseRoutingOptionDetailRoutingProductTypes[]|null
     */
    public function getRoutingProductTypes()
    {
        return $this->container['routing_product_types'];
    }

    /**
     * Sets routing_product_types
     *
     * @param \OpenAPI\Client\Model\ResponseRoutingOptionDetailRoutingProductTypes[]|null $routing_product_types routing_product_types
     *
     * @return self
     */
    public function setRoutingProductTypes($routing_product_types)
    {
        $this->container['routing_product_types'] = $routing_product_types;

        return $this;
    }

    /**
     * Gets routing_trunk_groups
     *
     * @return \OpenAPI\Client\Model\ResponseRoutingOptionDetailRoutingTrunkGroups[]|null
     */
    public function getRoutingTrunkGroups()
    {
        return $this->container['routing_trunk_groups'];
    }

    /**
     * Sets routing_trunk_groups
     *
     * @param \OpenAPI\Client\Model\ResponseRoutingOptionDetailRoutingTrunkGroups[]|null $routing_trunk_groups routing_trunk_groups
     *
     * @return self
     */
    public function setRoutingTrunkGroups($routing_trunk_groups)
    {
        $this->container['routing_trunk_groups'] = $routing_trunk_groups;
