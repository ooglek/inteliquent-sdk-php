<?php
/**
 * TrunkGroupOrderDetailTrunkGroupOrderDetailCustomerSipSignalingList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderDetailTrunkGroupOrderDetailCustomerSipSignalingList Class Doc Comment
 *
 * @category Class
 * @description Contains Customer SIP Details
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TrunkGroupOrderDetailTrunkGroupOrderDetailCustomerSipSignalingList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrunkGroupOrderDetail_trunkGroupOrderDetail_customerSipSignalingList';
    ...
    protected static $openAPITypes = [
        'customer_sip_signaling_item' => '\OpenAPI\Client\Model\TrunkGroupOrderDetailTrunkGroupOrderDetailCustomerSipSignalingListCustomerSipSignalingItem[]'
    ];
    ...
    protected static $openAPIFormats = [
        'customer_sip_signaling_item' => null
    ];
    ...
    protected static $attributeMap = [
        'customer_sip_signaling_item' => 'customerSipSignalingItem'
    ];
    ...
    protected static $setters = [
        'customer_sip_signaling_item' => 'setCustomerSipSignalingItem'
    ];
    ...
    protected static $getters = [
        'customer_sip_signaling_item' => 'getCustomerSipSignalingItem'
    ];
    ...
    {
        $this->container['customer_sip_signaling_item'] = $data['customer_sip_signaling_item'] ?? null;
    }
    ...
    /**
     * Gets customer_sip_signaling_item
     *
     * @return \OpenAPI\Client\Model\TrunkGroupOrderDetailTrunkGroupOrderDetailCustomerSipSignalingListCustomerSipSignalingItem[]|null
     */
    public function getCustomerSipSignalingItem()
    {
        return $this->container['customer_sip_signaling_item'];
    }

    /**
     * Sets customer_sip_signaling_item
     *
     * @param \OpenAPI\Client\Model\TrunkGroupOrderDetailTrunkGroupOrderDetailCustomerSipSignalingListCustomerSipSignalingItem[]|null $customer_sip_signaling_item customer_sip_signaling_item
     *
     * @return self
     */
    public function setCustomerSipSignalingItem($customer_sip_signaling_item)
    {
        $this->container['customer_sip_signaling_item'] = $customer_sip_signaling_item;
