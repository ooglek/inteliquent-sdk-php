...
/**
 * InlineResponse4251 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4251 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_425_1';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 425
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Unable to provision messaging for this TN. Please contact Inteliquent messaging team | Cannot update message class on TN with campaign | Unable to remove messaging for this TN. Please contact Inteliquent messaging team.
     *
     * @return self
     */
