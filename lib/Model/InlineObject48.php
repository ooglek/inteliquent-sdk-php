...
class InlineObject48 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type_trouble_ticket_status_name' => 'string',
        'type_trouble_ticket_status_exclude' => 'string',
        'min_enter_date' => '\DateTime',
        'max_enter_date' => '\DateTime',
        'type_trouble_ticket_problem_code_reference' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'type_trouble_ticket_status_name' => null,
        'type_trouble_ticket_status_exclude' => null,
        'min_enter_date' => 'date',
        'max_enter_date' => 'date',
        'type_trouble_ticket_problem_code_reference' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'type_trouble_ticket_status_name' => 'typeTroubleTicketStatusName',
        'type_trouble_ticket_status_exclude' => 'typeTroubleTicketStatusExclude',
        'min_enter_date' => 'minEnterDate',
        'max_enter_date' => 'maxEnterDate',
        'type_trouble_ticket_problem_code_reference' => 'typeTroubleTicketProblemCodeReference'
    ];
    ...
    protected static $setters = [
        ...
        'type_trouble_ticket_status_name' => 'setTypeTroubleTicketStatusName',
        'type_trouble_ticket_status_exclude' => 'setTypeTroubleTicketStatusExclude',
        'min_enter_date' => 'setMinEnterDate',
        'max_enter_date' => 'setMaxEnterDate',
        'type_trouble_ticket_problem_code_reference' => 'setTypeTroubleTicketProblemCodeReference'
    ];
    ...
    protected static $getters = [
        ...
        'type_trouble_ticket_status_name' => 'getTypeTroubleTicketStatusName',
        'type_trouble_ticket_status_exclude' => 'getTypeTroubleTicketStatusExclude',
        'min_enter_date' => 'getMinEnterDate',
        'max_enter_date' => 'getMaxEnterDate',
        'type_trouble_ticket_problem_code_reference' => 'getTypeTroubleTicketProblemCodeReference'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type_trouble_ticket_status_name'] = $data['type_trouble_ticket_status_name'] ?? null;
        $this->container['type_trouble_ticket_status_exclude'] = $data['type_trouble_ticket_status_exclude'] ?? null;
        $this->container['min_enter_date'] = $data['min_enter_date'] ?? null;
        $this->container['max_enter_date'] = $data['max_enter_date'] ?? null;
        $this->container['type_trouble_ticket_problem_code_reference'] = $data['type_trouble_ticket_problem_code_reference'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trouble_ticket_id'] === null) {
            $invalidProperties[] = "'trouble_ticket_id' can't be null";
        }
     ...
     *
     * @param int $trouble_ticket_id Existing trouble ticket number
     *
     * @return self
     */
    ...
    /**
     * Gets type_trouble_ticket_status_name
     *
     * @return string|null
     */
    public function getTypeTroubleTicketStatusName()
    {
        return $this->container['type_trouble_ticket_status_name'];
    }

    /**
     * Sets type_trouble_ticket_status_name
     *
     * @param string|null $type_trouble_ticket_status_name Type trouble ticket status name
     *
     * @return self
     */
    public function setTypeTroubleTicketStatusName($type_trouble_ticket_status_name)
    {
        $this->container['type_trouble_ticket_status_name'] = $type_trouble_ticket_status_name;

        return $this;
    }

    /**
     * Gets type_trouble_ticket_status_exclude
     *
     * @return string|null
     */
    public function getTypeTroubleTicketStatusExclude()
    {
        return $this->container['type_trouble_ticket_status_exclude'];
    }

    /**
     * Sets type_trouble_ticket_status_exclude
     *
     * @param string|null $type_trouble_ticket_status_exclude type trouble ticet status exclude
     *
     * @return self
     */
    public function setTypeTroubleTicketStatusExclude($type_trouble_ticket_status_exclude)
    {
        $this->container['type_trouble_ticket_status_exclude'] = $type_trouble_ticket_status_exclude;
     ...
     * Sets min_enter_date
     *
     * @param \DateTime|null $min_enter_date Minimum Date
     *
     * @return self
     */
     ...
     * Sets max_enter_date
     *
     * @param \DateTime|null $max_enter_date Maximum enter date
     *
     * @return self
     */
    ...
    /**
     * Gets type_trouble_ticket_problem_code_reference
     *
     * @return string|null
     */
    public function getTypeTroubleTicketProblemCodeReference()
    {
        return $this->container['type_trouble_ticket_problem_code_reference'];
    }

    /**
     * Sets type_trouble_ticket_problem_code_reference
     *
     * @param string|null $type_trouble_ticket_problem_code_reference Type Trouble Ticket Problem Code Reference
     *
     * @return self
     */
    public function setTypeTroubleTicketProblemCodeReference($type_trouble_ticket_problem_code_reference)
    {
        $this->container['type_trouble_ticket_problem_code_reference'] = $type_trouble_ticket_problem_code_reference;
