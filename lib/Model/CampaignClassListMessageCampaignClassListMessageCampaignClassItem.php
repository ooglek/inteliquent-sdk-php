<?php
/**
 * CampaignClassListMessageCampaignClassListMessageCampaignClassItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CampaignClassListMessageCampaignClassListMessageCampaignClassItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignClassListMessageCampaignClassListMessageCampaignClassItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignClassList_messageCampaignClassList_messageCampaignClassItem';
    ...
    protected static $openAPITypes = [
        'messaging_campaign_class_name' => 'string',
        'messaging_campaign_class_reference' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'messaging_campaign_class_name' => null,
        'messaging_campaign_class_reference' => null
    ];
    ...
    protected static $attributeMap = [
        'messaging_campaign_class_name' => 'messagingCampaignClassName',
        'messaging_campaign_class_reference' => 'messagingCampaignClassReference'
    ];
    ...
    protected static $setters = [
        'messaging_campaign_class_name' => 'setMessagingCampaignClassName',
        'messaging_campaign_class_reference' => 'setMessagingCampaignClassReference'
    ];
    ...
    protected static $getters = [
        'messaging_campaign_class_name' => 'getMessagingCampaignClassName',
        'messaging_campaign_class_reference' => 'getMessagingCampaignClassReference'
    ];
    ...
    {
        $this->container['messaging_campaign_class_name'] = $data['messaging_campaign_class_name'] ?? null;
        $this->container['messaging_campaign_class_reference'] = $data['messaging_campaign_class_reference'] ?? null;
    }
    ...
    /**
     * Gets messaging_campaign_class_name
     *
     * @return string|null
     */
    public function getMessagingCampaignClassName()
    {
        return $this->container['messaging_campaign_class_name'];
    }

    /**
     * Sets messaging_campaign_class_name
     *
     * @param string|null $messaging_campaign_class_name Campaign Class Name
     *
     * @return self
     */
    public function setMessagingCampaignClassName($messaging_campaign_class_name)
    {
        $this->container['messaging_campaign_class_name'] = $messaging_campaign_class_name;

        return $this;
    }

    /**
     * Gets messaging_campaign_class_reference
     *
     * @return string|null
     */
    public function getMessagingCampaignClassReference()
    {
        return $this->container['messaging_campaign_class_reference'];
    }

    /**
     * Sets messaging_campaign_class_reference
     *
     * @param string|null $messaging_campaign_class_reference Campaign Class Reference
     *
     * @return self
     */
    public function setMessagingCampaignClassReference($messaging_campaign_class_reference)
    {
        $this->container['messaging_campaign_class_reference'] = $messaging_campaign_class_reference;
