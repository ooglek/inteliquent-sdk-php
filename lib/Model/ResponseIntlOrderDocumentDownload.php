<?php
/**
 * ResponseIntlOrderDocumentDownload
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseIntlOrderDocumentDownload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseIntlOrderDocumentDownload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlOrderDocumentDownload';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'document' => '\OpenAPI\Client\Model\ResponseIntlOrderDocumentDownloadDocument'
    ];
     ...
     * Gets document
     *
     * @return \OpenAPI\Client\Model\ResponseIntlOrderDocumentDownloadDocument|null
     */
     ...
     * Sets document
     *
     * @param \OpenAPI\Client\Model\ResponseIntlOrderDocumentDownloadDocument|null $document document
     *
     * @return self
     */
