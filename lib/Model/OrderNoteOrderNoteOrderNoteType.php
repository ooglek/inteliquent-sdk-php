<?php
/**
 * OrderNoteOrderNoteOrderNoteType
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * OrderNoteOrderNoteOrderNoteType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderNoteOrderNoteOrderNoteType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderNote_orderNote_OrderNoteType';
     ...
     * Sets note
     *
     * @param string|null $note Note text of this note.
     *
     * @return self
     */
     ...
     * Sets insert_user
     *
     * @param string|null $insert_user User who inserted this note.
     *
     * @return self
     */
