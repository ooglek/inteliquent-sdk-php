...
/**
 * InlineResponse4152 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4152 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_415_2';
     ...
     * Sets status
     *
     * @param string|null $status Unable to add:Order Document
     *
     * @return self
     */
