...
/**
 * InlineResponse40931 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40931 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_31';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 409
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(All Input Fields) | Invalid TN submitted:(Tn List) | Invalid ForwardTo submitted for TN/s:(Tn List) | Invalid TN submitted:Must be of 10 Digits | CustomerOrderReference has invalid characters and cannot include <, \\\\, ^, ~, `, }, {, >, =, ], [, !
     *
     * @return self
     */
