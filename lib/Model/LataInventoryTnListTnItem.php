...
/**
 * LataInventoryTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LataInventoryTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_lataInventory_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number (e.g. 8156680000)
     *
     * @return self
     */
