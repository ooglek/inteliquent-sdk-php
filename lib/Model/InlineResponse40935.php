...
/**
 * InlineResponse40935 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40935 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_35';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:desiredDueDate must be on or after 12-May-2022 (3 business days). or Invalid Input Parameters:desiredDueDate must be on or after 10-May-2022 (next business day).
     *
     * @return self
     */
