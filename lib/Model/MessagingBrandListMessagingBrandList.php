<?php
/**
 * MessagingBrandListMessagingBrandList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * MessagingBrandListMessagingBrandList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagingBrandListMessagingBrandList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagingBrandList_messagingBrandList';
    ...
    protected static $openAPITypes = [
        'messaging_brand_item' => '\OpenAPI\Client\Model\MessagingBrandListMessagingBrandListMessagingBrandItem[]'
    ];
    ...
    protected static $attributeMap = [
        'messaging_brand_item' => 'messagingBrandItem'
    ];
    ...
    protected static $setters = [
        'messaging_brand_item' => 'setMessagingBrandItem'
    ];
    ...
    protected static $getters = [
        'messaging_brand_item' => 'getMessagingBrandItem'
    ];
    ...
    {
        $this->container['messaging_brand_item'] = $data['messaging_brand_item'] ?? null;
    }
    ...
    /**
     * Gets messaging_brand_item
     *
     * @return \OpenAPI\Client\Model\MessagingBrandListMessagingBrandListMessagingBrandItem[]|null
     */
    public function getMessagingBrandItem()
    {
        return $this->container['messaging_brand_item'];
    }

    /**
     * Sets messaging_brand_item
     *
     * @param \OpenAPI\Client\Model\MessagingBrandListMessagingBrandListMessagingBrandItem[]|null $messaging_brand_item messaging_brand_item
     *
     * @return self
     */
    public function setMessagingBrandItem($messaging_brand_item)
    {
        $this->container['messaging_brand_item'] = $messaging_brand_item;
