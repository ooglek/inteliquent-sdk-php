...
class InlineResponse4094 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(All Input Fields) | Campaign has TNs associated please remove the TNs and try again |  Invalid externalCampaignId format | externalCampaignId is not ACTIVE |  externalCampaignId is not registered
     *
     * @return self
     */
