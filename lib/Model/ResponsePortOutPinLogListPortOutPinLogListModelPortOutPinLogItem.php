...
/**
 * ResponsePortOutPinLogListPortOutPinLogListModelPortOutPinLogItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponsePortOutPinLogListPortOutPinLogListModelPortOutPinLogItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePortOutPinLogList_portOutPinLogList_model_portOutPinLogItem';
    ...
    {
        $this->container['log_ts'] = $data['log_ts'] ?? null;
        $this->container['log_user'] = $data['log_user'] ?? null;
    ...
    {
        return $this->container['log_ts'];
    }

    /**
     * Sets log_ts
     *
     * @param string|null $log_ts log_ts
     *
     * @return self
     */
    public function setLogTs($log_ts)
    {
        $this->container['log_ts'] = $log_ts;
    ...
    {
        return $this->container['log_user'];
    }

    /**
     * Sets log_user
     *
     * @param string|null $log_user log_user
     *
     * @return self
     */
    public function setLogUser($log_user)
    {
        $this->container['log_user'] = $log_user;
