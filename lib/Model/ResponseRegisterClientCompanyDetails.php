<?php
/**
 * ResponseRegisterClientCompanyDetails
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseRegisterClientCompanyDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseRegisterClientCompanyDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRegisterClient_companyDetails';
     ...
     * Sets private_key
     *
     * @param string|null $private_key Key that just got generated
     *
     * @return self
     */
     ...
     * Sets api_secret
     *
     * @param string|null $api_secret Secret that just got generated
     *
     * @return self
     */
     ...
     * Sets key_name
     *
     * @param string|null $key_name Key Name if sent in as part of the request
     *
     * @return self
     */
