...
/**
 * InlineResponse4208 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4208 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_420_8';
     ...
     * Sets status
     *
     * @param string|null $status Invalid TN List.(TN List is null/empty)
     *
     * @return self
     */
