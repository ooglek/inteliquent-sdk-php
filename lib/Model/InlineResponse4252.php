...
/**
 * InlineResponse4252 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4252 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_425_2';
     ...
     * Sets status
     *
     * @param string|null $status Not all the TNs in the request were activated/order
     *
     * @return self
     */
