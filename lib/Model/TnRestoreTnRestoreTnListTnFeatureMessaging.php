<?php
/**
 * TnRestoreTnRestoreTnListTnFeatureMessaging
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnRestoreTnRestoreTnListTnFeatureMessaging Class Doc Comment
 *
 * @category Class
 ...
 */
class TnRestoreTnRestoreTnListTnFeatureMessaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnRestore_tnRestore_tnList_tnFeature_messaging';
     ...
     * Sets message_class
     *
     * @param string|null $message_class New or updated message class
     *
     * @return self
     */
     ...
     * Sets message_type
     *
     * @param string|null $message_type New or updated message type
     *
     * @return self
     */
     ...
     * Sets cancel_feature
     *
     * @param string|null $cancel_feature Enter Y to cancel a request to add messaging services to the telephone number
     *
     * @return self
     */
