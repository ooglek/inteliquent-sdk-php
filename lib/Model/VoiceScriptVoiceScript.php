...
/**
 * VoiceScriptVoiceScript Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VoiceScriptVoiceScript implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_voiceScript_voiceScript';
    ...
    protected static $setters = [
        ...
        'script' => 'setScript',
        'enabled' => 'setEnabled',
        'customer_default' => 'setCustomerDefault',
    ...
    protected static $getters = [
        ...
        'script' => 'getScript',
        'enabled' => 'getEnabled',
        'customer_default' => 'getCustomerDefault',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['customer_default'] = $data['customer_default'] ?? null;
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit telephone number to which script to be registered(e.g. 8156680000). Either a TN or a domain must be specified.
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain Domain to which script to be registered. Either a TN or a domain must be specified.
     *
     * @return self
     */
     ...
     * Sets script
     *
     * @param string|null $script Script that will be associated with the given tn or domain. Script must be specified if \"removeScript\" element is not set, implying that while adding a script to the domain or TN, script is a required element.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Either true or false to enable or disable the script for the domain or TN. Default is true.
     *
     * @return self
     */
    ...
    /**
     * Gets customer_default
     *
     * @return bool|null
     */
    public function getCustomerDefault()
    {
        return $this->container['customer_default'];
    }

    /**
     * Sets customer_default
     *
     * @param bool|null $customer_default Either true or false to enable or disable the script as the customer default. Default is false.
     *
     * @return self
     */
    public function setCustomerDefault($customer_default)
    {
        $this->container['customer_default'] = $customer_default;
     ...
     * Sets direction
     *
     * @param string|null $direction Value should be Inbound or Outbound. Direction is required to add, update or remove.
     *
     * @return self
     */
