...
/**
 * TnUpdateTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active telephone number(s) to update assigned trunk group
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnUpdateTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnUpdate_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TnUpdateTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TnUpdateTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TnUpdateTnListTnItem[]|null $tn_item Contains active telephone number(s) to update assigned trunk group
     *
     * @return self
     */
