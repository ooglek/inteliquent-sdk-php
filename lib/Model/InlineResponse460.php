...
/**
 * InlineResponse460 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse460 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_460';
     ...
     * Sets status
     *
     * @param string|null $status Unable to add more email notifications
     *
     * @return self
     */
