...
/**
 * InlineResponse4312 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4312 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_431_2';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 431
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Request exceeds the maximum number of reserved TNs | Unable to complete the request at the moment, please try again.
     *
     * @return self
     */
