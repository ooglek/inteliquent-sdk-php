...
/**
 * TnInventoryPageSort Class Doc Comment
 *
 * @category Class
 * @description Contains sorting and pagination parameters
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnInventoryPageSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnInventory_pageSort';
     ...
     * Sets page
     *
     * @param int|null $page Result page number; integer value
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Result page size; integer value
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param string|null $direction Result sort direction; acceptable values are asc, desc
     *
     * @return self
     */
     ...
     * Sets property
     *
     * @param string|null $property Result sort property; acceptable values are tn, rateCenter, lata, state, rateCenterTier
     *
     * @return self
     */
