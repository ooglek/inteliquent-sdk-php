...
/**
 * TfDnisTnList Class Doc Comment
 *
 * @category Class
 ...
 */
class TfDnisTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfDnis_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TfDnisTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TfDnisTnListTnItem[]
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TfDnisTnListTnItem[] $tn_item Contains active toll free number(s) to update
     *
     * @return self
     */
