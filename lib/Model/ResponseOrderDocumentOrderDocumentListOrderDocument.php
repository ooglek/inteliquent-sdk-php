<?php
/**
 * ResponseOrderDocumentOrderDocumentListOrderDocument
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseOrderDocumentOrderDocumentListOrderDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseOrderDocumentOrderDocumentListOrderDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseOrderDocument_orderDocumentList_orderDocument';
