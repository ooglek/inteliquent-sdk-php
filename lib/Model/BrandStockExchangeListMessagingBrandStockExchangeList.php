<?php
/**
 * BrandStockExchangeListMessagingBrandStockExchangeList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * BrandStockExchangeListMessagingBrandStockExchangeList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BrandStockExchangeListMessagingBrandStockExchangeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandStockExchangeList_messagingBrandStockExchangeList';
    ...
    protected static $openAPITypes = [
        'brand_stock_exchange_ref' => 'string',
        'brand_stock_exchange_name' => 'string',
        'abbreviation' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'brand_stock_exchange_ref' => null,
        'brand_stock_exchange_name' => null,
        'abbreviation' => null
    ];
    ...
    protected static $attributeMap = [
        'brand_stock_exchange_ref' => 'brandStockExchangeRef',
        'brand_stock_exchange_name' => 'brandStockExchangeName',
    ...
    protected static $setters = [
        'brand_stock_exchange_ref' => 'setBrandStockExchangeRef',
        'brand_stock_exchange_name' => 'setBrandStockExchangeName',
    ...
    protected static $getters = [
        'brand_stock_exchange_ref' => 'getBrandStockExchangeRef',
        'brand_stock_exchange_name' => 'getBrandStockExchangeName',
    ...
    {
        $this->container['brand_stock_exchange_ref'] = $data['brand_stock_exchange_ref'] ?? null;
        $this->container['brand_stock_exchange_name'] = $data['brand_stock_exchange_name'] ?? null;
    ...
    /**
     * Gets brand_stock_exchange_ref
     *
     * @return string|null
     */
    public function getBrandStockExchangeRef()
    {
        return $this->container['brand_stock_exchange_ref'];
    }

    /**
     * Sets brand_stock_exchange_ref
     *
     * @param string|null $brand_stock_exchange_ref Brand Stock Exchange reference.
     *
     * @return self
     */
    public function setBrandStockExchangeRef($brand_stock_exchange_ref)
    {
        $this->container['brand_stock_exchange_ref'] = $brand_stock_exchange_ref;

        return $this;
    }

    /**
     * Gets brand_stock_exchange_name
     *
     * @return string|null
     */
    public function getBrandStockExchangeName()
    {
        return $this->container['brand_stock_exchange_name'];
    }

    /**
     * Sets brand_stock_exchange_name
     *
     * @param string|null $brand_stock_exchange_name Stock Exchange name.
     *
     * @return self
     */
    public function setBrandStockExchangeName($brand_stock_exchange_name)
    {
        $this->container['brand_stock_exchange_name'] = $brand_stock_exchange_name;
     ...
     * Sets abbreviation
     *
     * @param string|null $abbreviation Stock Exchange abbreviation.
     *
     * @return self
     */
