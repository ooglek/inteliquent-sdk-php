...
/**
 * InlineResponse41431 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41431 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_31';
     ...
     * Sets status
     *
     * @param string|null $status Large result set without searchId detected. Please contact support team for assistance. | Fields Are Required:(All Required Fields)
     *
     * @return self
     */
