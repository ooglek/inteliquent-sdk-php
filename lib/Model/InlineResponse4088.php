...
/**
 * InlineResponse4088 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4088 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_408_8';
     ...
     * Sets status
     *
     * @param string|null $status Error text listing the actual error that occured  | Private Key cannot be blank./messagingBrandList
     *
     * @return self
     */
