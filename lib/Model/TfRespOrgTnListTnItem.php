...
/**
 * TfRespOrgTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfRespOrgTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfRespOrg_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit toll free number (e.g. 8886680000)
     *
     * @return self
     */
