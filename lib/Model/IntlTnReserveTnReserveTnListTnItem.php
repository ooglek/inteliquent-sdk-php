<?php
/**
 * IntlTnReserveTnReserveTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * IntlTnReserveTnReserveTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntlTnReserveTnReserveTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_intlTnReserve_tnReserve_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit telephone number requested (e.g. 3156680000)
     *
     * @return self
     */
