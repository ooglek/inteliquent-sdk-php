<?php
/**
 * TimeProfileTimeProfileScheduleDayOfWeek
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TimeProfileTimeProfileScheduleDayOfWeek Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TimeProfileTimeProfileScheduleDayOfWeek implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_timeProfile_timeProfile_schedule_day_of_week';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['start_minute'] = $data['start_minute'] ?? null;
        $this->container['end_hour'] = $data['end_hour'] ?? null;
        $this->container['end_minute'] = $data['end_minute'] ?? null;
    }
     ...
     * Sets start_hour
     *
     * @param int|null $start_hour Start hour of the time range
     *
     * @return self
     */
     ...
     * Sets start_minute
     *
     * @param int|null $start_minute Start minute of the time range
     *
     * @return self
     */
     ...
     * Sets end_hour
     *
     * @param int|null $end_hour End hour of the time range
     *
     * @return self
     */
     ...
     * Sets end_minute
     *
     * @param int|null $end_minute End minute of the time range
     *
     * @return self
     */
