<?php
/**
 * ResponseRoutingLabelSearchAssignedRoutingLabelList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseRoutingLabelSearchAssignedRoutingLabelList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseRoutingLabelSearchAssignedRoutingLabelList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRoutingLabelSearchAssigned_routingLabelList';
    ...
    protected static $openAPITypes = [
        'routing_label_item' => '\OpenAPI\Client\Model\ResponseRoutingLabelSearchAssignedRoutingLabelListRoutingLabelItem[]'
    ];
    ...
    protected static $attributeMap = [
        'routing_label_item' => 'routingLabelItem'
    ];
    ...
    protected static $setters = [
        'routing_label_item' => 'setRoutingLabelItem'
    ];
    ...
    protected static $getters = [
        'routing_label_item' => 'getRoutingLabelItem'
    ];
    ...
    {
        $this->container['routing_label_item'] = $data['routing_label_item'] ?? null;
    }
    ...
    /**
     * Gets routing_label_item
     *
     * @return \OpenAPI\Client\Model\ResponseRoutingLabelSearchAssignedRoutingLabelListRoutingLabelItem[]|null
     */
    public function getRoutingLabelItem()
    {
        return $this->container['routing_label_item'];
    }

    /**
     * Sets routing_label_item
     *
     * @param \OpenAPI\Client\Model\ResponseRoutingLabelSearchAssignedRoutingLabelListRoutingLabelItem[]|null $routing_label_item routing_label_item
     *
     * @return self
     */
    public function setRoutingLabelItem($routing_label_item)
    {
        $this->container['routing_label_item'] = $routing_label_item;
