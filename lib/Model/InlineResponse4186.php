...
/**
 * InlineResponse4186 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4186 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_418_6';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 418
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Character limit is exceeded for:(String inputs) | Character limit is exceeded for:customerOrderReference
     *
     * @return self
     */
