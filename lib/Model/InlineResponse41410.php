...
/**
 * InlineResponse41410 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41410 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_10';
     ...
     * Sets status
     *
     * @param string|null $status FUser error occured.  Status lists the specific error.
     *
     * @return self
     */
