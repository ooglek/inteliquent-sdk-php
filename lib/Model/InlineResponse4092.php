...
class InlineResponse4092 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(All Input Fields) | Invalid messagingBrandId format, should start with B and contain alphanumeric characters only
     *
     * @return self
     */
