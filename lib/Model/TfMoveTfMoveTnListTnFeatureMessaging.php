<?php
/**
 * TfMoveTfMoveTnListTnFeatureMessaging
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TfMoveTfMoveTnListTnFeatureMessaging Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfMoveTfMoveTnListTnFeatureMessaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfMove_tfMove_tnList_tnFeature_messaging';
     ...
     * Sets message_class
     *
     * @param string|null $message_class Acceptable values is A2P8XX
     *
     * @return self
     */
