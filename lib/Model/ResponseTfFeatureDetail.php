...
/**
 * ResponseTfFeatureDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTfFeatureDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTfFeatureDetail';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'tf_feature_list' => '\OpenAPI\Client\Model\ResponseTfFeatureDetailTfFeatureList'
    ];
     ...
     *
     * @return \OpenAPI\Client\Model\ResponseTfFeatureDetailTfFeatureList|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ResponseTfFeatureDetailTfFeatureList|null $tf_feature_list tf_feature_list
     *
     * @return self
     */
