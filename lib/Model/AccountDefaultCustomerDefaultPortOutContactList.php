<?php
/**
 * AccountDefaultCustomerDefaultPortOutContactList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * AccountDefaultCustomerDefaultPortOutContactList Class Doc Comment
 *
 * @category Class
 * @description Contains one or more port-out contacts
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccountDefaultCustomerDefaultPortOutContactList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_accountDefault_customerDefault_portOutContactList';
    ...
    protected static $openAPITypes = [
        'port_out_contact_item' => '\OpenAPI\Client\Model\AccountDefaultCustomerDefaultPortOutContactListPortOutContactItem[]'
    ];
     ...
     *
     * @return \OpenAPI\Client\Model\AccountDefaultCustomerDefaultPortOutContactListPortOutContactItem[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountDefaultCustomerDefaultPortOutContactListPortOutContactItem[]|null $port_out_contact_item Contains one or more port-out contacts
     *
     * @return self
     */
