...
/**
 * InlineResponse4142 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4142 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_2';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:<name Of Field>  | (Different Permission Errors)
     *
     * @return self
     */
