...
/**
 * InlineResponse4144 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4144 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_4';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(For All required Fields) | Invalid Date format:(For Date Fields)
     *
     * @return self
     */
