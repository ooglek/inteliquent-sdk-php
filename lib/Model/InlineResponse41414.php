...
/**
 * InlineResponse41414 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41414 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_14';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:<name Of Field> | (Different Errors)
     *
     * @return self
     */
