<?php
/**
 * ResponseIntlExcludedTnListIntlExcludedTnList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseIntlExcludedTnListIntlExcludedTnList Class Doc Comment
 *
 * @category Class
 * @description Encompassing object that holds routing Option List
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseIntlExcludedTnListIntlExcludedTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlExcludedTnList_intlExcludedTnList';
    ...
    protected static $openAPITypes = [
        'excluded_tn_item' => '\OpenAPI\Client\Model\ResponseIntlExcludedTnListIntlExcludedTnListExcludedTnItem'
    ];
    ...
    protected static $attributeMap = [
        'excluded_tn_item' => 'excludedTnItem'
    ];
    ...
    protected static $setters = [
        'excluded_tn_item' => 'setExcludedTnItem'
    ];
    ...
    protected static $getters = [
        'excluded_tn_item' => 'getExcludedTnItem'
    ];
    ...
    {
        $this->container['excluded_tn_item'] = $data['excluded_tn_item'] ?? null;
    }
    ...
    /**
     * Gets excluded_tn_item
     *
     * @return \OpenAPI\Client\Model\ResponseIntlExcludedTnListIntlExcludedTnListExcludedTnItem|null
     */
    public function getExcludedTnItem()
    {
        return $this->container['excluded_tn_item'];
    }

    /**
     * Sets excluded_tn_item
     *
     * @param \OpenAPI\Client\Model\ResponseIntlExcludedTnListIntlExcludedTnListExcludedTnItem|null $excluded_tn_item excluded_tn_item
     *
     * @return self
     */
    public function setExcludedTnItem($excluded_tn_item)
    {
        $this->container['excluded_tn_item'] = $excluded_tn_item;
