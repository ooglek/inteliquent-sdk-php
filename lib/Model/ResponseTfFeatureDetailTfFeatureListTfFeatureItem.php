<?php
/**
 * ResponseTfFeatureDetailTfFeatureListTfFeatureItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTfFeatureDetailTfFeatureListTfFeatureItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTfFeatureDetailTfFeatureListTfFeatureItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTfFeatureDetail_tfFeatureList_tfFeatureItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tf_status'] = $data['tf_status'] ?? null;
     ...
     * Sets tn
     *
     * @param int|null $tn telephone number requested
     *
     * @return self
     */
     ...
     * Sets message_class
     *
     * @param string|null $message_class message_class
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getTfStatus()
    {
        return $this->container['tf_status'];
    }

    /**
     * Sets tf_status
     *
     * @param string|null $tf_status tf_status
     *
     * @return self
     */
    public function setTfStatus($tf_status)
    {
        $this->container['tf_status'] = $tf_status;
