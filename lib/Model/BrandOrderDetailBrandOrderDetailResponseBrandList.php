<?php
/**
 * BrandOrderDetailBrandOrderDetailResponseBrandList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * BrandOrderDetailBrandOrderDetailResponseBrandList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BrandOrderDetailBrandOrderDetailResponseBrandList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandOrderDetail_brandOrderDetailResponse_brandList';
    ...
    protected static $openAPITypes = [
        'brand_item' => '\OpenAPI\Client\Model\BrandOrderDetailBrandOrderDetailResponseBrandListBrandItem[]'
    ];
    ...
    {
        $this->container['brand_item'] = $data['brand_item'] ?? null;
    }
     ...
     * Gets brand_item
     *
     * @return \OpenAPI\Client\Model\BrandOrderDetailBrandOrderDetailResponseBrandListBrandItem[]|null
     */
    public function getBrandItem()
    {
        return $this->container['brand_item'];
    }

    /**
     * Sets brand_item
     *
     * @param \OpenAPI\Client\Model\BrandOrderDetailBrandOrderDetailResponseBrandListBrandItem[]|null $brand_item brand_item
     *
     * @return self
     */
    public function setBrandItem($brand_item)
    {
        $this->container['brand_item'] = $brand_item;
