...
/**
 * InlineResponse4151 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4151 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_415_1';
     ...
     * Sets status
     *
     * @param string|null $status Unable to add:Trouble Ticket Note
     *
     * @return self
     */
