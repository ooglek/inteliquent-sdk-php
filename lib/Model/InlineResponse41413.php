...
/**
 * InlineResponse41413 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41413 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_13';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 414
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Field Required- (All Input Fields) | Account not message-enabled, remove messaging from request | Large result set without searchId detected. Please contact support team for assistance.
     *
     * @return self
     */
