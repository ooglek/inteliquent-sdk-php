<?php
/**
 * ResponsePortOutPinLogListPortOutPinLogList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponsePortOutPinLogListPortOutPinLogList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponsePortOutPinLogListPortOutPinLogList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePortOutPinLogList_portOutPinLogList';
    ...
    protected static $openAPITypes = [
        'modelport_out_pin_log_item' => '\OpenAPI\Client\Model\ResponsePortOutPinLogListPortOutPinLogListModelPortOutPinLogItem[]'
    ];
    ...
    protected static $openAPIFormats = [
        'modelport_out_pin_log_item' => null
    ];
    ...
    protected static $attributeMap = [
        'modelport_out_pin_log_item' => 'model:portOutPinLogItem'
    ];
    ...
    protected static $setters = [
        'modelport_out_pin_log_item' => 'setModelportOutPinLogItem'
    ];
    ...
    protected static $getters = [
        'modelport_out_pin_log_item' => 'getModelportOutPinLogItem'
    ];
    ...
    {
        $this->container['modelport_out_pin_log_item'] = $data['modelport_out_pin_log_item'] ?? null;
    }
    ...
    /**
     * Gets modelport_out_pin_log_item
     *
     * @return \OpenAPI\Client\Model\ResponsePortOutPinLogListPortOutPinLogListModelPortOutPinLogItem[]|null
     */
    public function getModelportOutPinLogItem()
    {
        return $this->container['modelport_out_pin_log_item'];
    }

    /**
     * Sets modelport_out_pin_log_item
     *
     * @param \OpenAPI\Client\Model\ResponsePortOutPinLogListPortOutPinLogListModelPortOutPinLogItem[]|null $modelport_out_pin_log_item modelport_out_pin_log_item
     *
     * @return self
     */
    public function setModelportOutPinLogItem($modelport_out_pin_log_item)
    {
        $this->container['modelport_out_pin_log_item'] = $modelport_out_pin_log_item;
