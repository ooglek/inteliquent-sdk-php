...
/**
 * InlineResponse41012 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41012 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410_12';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Order ID | DB Error:(Database Error)
     *
     * @return self
     */
