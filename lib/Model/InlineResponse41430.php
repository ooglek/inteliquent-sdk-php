...
/**
 * InlineResponse41430 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41430 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_30';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Postal Code is Invalid |  Invalid Address Information.
     *
     * @return self
     */
