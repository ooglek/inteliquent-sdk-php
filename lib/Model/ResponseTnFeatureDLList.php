...
/**
 * ResponseTnFeatureDLList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnFeatureDLList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnFeatureDLList';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'tn_feature_list' => '\OpenAPI\Client\Model\ResponseTnFeatureDLListTnFeatureList'
    ];
     ...
     *
     * @return \OpenAPI\Client\Model\ResponseTnFeatureDLListTnFeatureList|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ResponseTnFeatureDLListTnFeatureList|null $tn_feature_list tn_feature_list
     *
     * @return self
     */
