...
/**
 * TfOrderTfOrder Class Doc Comment
 *
 * @category Class
 * @description Contains order details for toll free numbers
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TfOrderTfOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfOrder_tfOrder';
    ...
    protected static $openAPITypes = [
        ...
        'loa' => 'string',
        'tn_list' => '\OpenAPI\Client\Model\TfOrderTfOrderTnList'
    ];
     ...
     * Sets loa
     *
     * @param string|null $loa Must be sent as Y and you must use orderAddDocument to attach a valid LOA and bill copy when productAbbr is 8XXPORTIN
     *
     * @return self
     */
     ...
     * Gets tn_list
     *
     * @return \OpenAPI\Client\Model\TfOrderTfOrderTnList|null
     */
     ...
     * Sets tn_list
     *
     * @param \OpenAPI\Client\Model\TfOrderTfOrderTnList|null $tn_list tn_list
     *
     * @return self
     */
