...
class InlineObject21 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['msg_brand_id'] === null) {
            $invalidProperties[] = "'msg_brand_id' can't be null";
        }
     ...
     * Sets msg_brand_id
     *
     * @param string $msg_brand_id Brand ID for whom use cases are being retrieved
     *
     * @return self
     */
