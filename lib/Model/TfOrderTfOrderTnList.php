...
/**
 * TfOrderTfOrderTnList Class Doc Comment
 *
 * @category Class
 * @description Contains requested toll free number(s)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TfOrderTfOrderTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfOrder_tfOrder_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TfOrderTfOrderTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TfOrderTfOrderTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TfOrderTfOrderTnListTnItem[]|null $tn_item Contains requested toll free number(s)
     *
     * @return self
     */
