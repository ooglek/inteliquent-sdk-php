<?php
/**
 * ResponseRoutingLabelSearchAssignedRoutingLabelListRoutingLabelItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseRoutingLabelSearchAssignedRoutingLabelListRoutingLabelItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseRoutingLabelSearchAssignedRoutingLabelListRoutingLabelItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRoutingLabelSearchAssigned_routingLabelList_routingLabelItem';
    ...
    protected static $openAPITypes = [
        ...
        'route_prioritization_type' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'customer_assigned_name' => null,
        'routing_label' => null,
        'route_prioritization_type' => null
    ];
    ...
    protected static $attributeMap = [
        'customer_assigned_name' => 'customerAssignedName',
        'routing_label' => 'routingLabel',
        'route_prioritization_type' => 'routePrioritizationType'
    ];
    ...
    protected static $setters = [
        'customer_assigned_name' => 'setCustomerAssignedName',
        'routing_label' => 'setRoutingLabel',
        'route_prioritization_type' => 'setRoutePrioritizationType'
    ];
    ...
    protected static $getters = [
        'customer_assigned_name' => 'getCustomerAssignedName',
        'routing_label' => 'getRoutingLabel',
        'route_prioritization_type' => 'getRoutePrioritizationType'
    ];
    ...
    {
        $this->container['customer_assigned_name'] = $data['customer_assigned_name'] ?? null;
        $this->container['routing_label'] = $data['routing_label'] ?? null;
        $this->container['route_prioritization_type'] = $data['route_prioritization_type'] ?? null;
    }
    ...
    /**
     * Gets customer_assigned_name
     *
     * @return string|null
     */
    public function getCustomerAssignedName()
    {
        return $this->container['customer_assigned_name'];
    }

    /**
     * Sets customer_assigned_name
     *
     * @param string|null $customer_assigned_name customer assigned Name
     *
     * @return self
     */
    public function setCustomerAssignedName($customer_assigned_name)
    {
        $this->container['customer_assigned_name'] = $customer_assigned_name;
     ...
     * Sets routing_label
     *
     * @param string|null $routing_label routing Name
     *
     * @return self
     */
    ...
    /**
     * Gets route_prioritization_type
     *
     * @return string|null
     */
    public function getRoutePrioritizationType()
    {
        return $this->container['route_prioritization_type'];
    }

    /**
     * Sets route_prioritization_type
     *
     * @param string|null $route_prioritization_type route_prioritization_type
     *
     * @return self
     */
    public function setRoutePrioritizationType($route_prioritization_type)
    {
        $this->container['route_prioritization_type'] = $route_prioritization_type;
