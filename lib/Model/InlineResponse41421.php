...
/**
 * InlineResponse41421 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41421 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_21';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) |  (Required Fields) | Toll Free Messaging is not enabled | tnNote must not exceed 4000 characters for TN/s
     *
     * @return self
     */
