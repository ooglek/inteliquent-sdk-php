<?php
/**
 * PortOutPinUpdatePortOutPinTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PortOutPinUpdatePortOutPinTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortOutPinUpdatePortOutPinTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_portOutPinUpdate_portOutPin_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number to add PIN (e.g. 8156680000)
     *
     * @return self
     */
     ...
     * Sets port_out_pin
     *
     * @param string $port_out_pin PIN for onnet port-out protection (Tier 0 & HI)
     *
     * @return self
     */
