...
/**
 * TfBtnTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfBtnTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfBtn_tnList_tnItem';
    ...
    protected static $attributeMap = [
        ...
        'remove_billing_tn' => 'removeBillingTn'
    ];
    ...
    protected static $setters = [
        ...
        'remove_billing_tn' => 'setRemoveBillingTn'
    ];
    ...
    protected static $getters = [
        ...
        'remove_billing_tn' => 'getRemoveBillingTn'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['remove_billing_tn'] = $data['remove_billing_tn'] ?? null;
    }
     ...
     * Sets tn
     *
     * @param int $tn Ten-digit toll free number to update (e.g. 8886680000)
     *
     * @return self
     */
     ...
     * Sets billing_tn
     *
     * @param string|null $billing_tn Ten-digit billing Tn to assign to toll free number (e.g. 8886681234)
     *
     * @return self
     */
    ...
    /**
     * Gets remove_billing_tn
     *
     * @return string|null
     */
    public function getRemoveBillingTn()
    {
        return $this->container['remove_billing_tn'];
    }

    /**
     * Sets remove_billing_tn
     *
     * @param string|null $remove_billing_tn Should be set to 'Y' to remove billing Tn from toll free number
     *
     * @return self
     */
    public function setRemoveBillingTn($remove_billing_tn)
    {
        $this->container['remove_billing_tn'] = $remove_billing_tn;
