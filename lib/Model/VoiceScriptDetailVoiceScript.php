...
/**
 * VoiceScriptDetailVoiceScript Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VoiceScriptDetailVoiceScript implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_voiceScriptDetail_voiceScript';
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit telephone number to which script to be registered(e.g. 8156680000).
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain Domain to which script to be registered.
     *
     * @return self
     */
     ...
     * Sets script_type
     *
     * @param string|null $script_type Valid values are \"NUMBER\" or \"DOMAIN\". To do a blanket search for all TNs or all domains search, this parameter must be specified.
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param string|null $direction Value should be Inbound or Outbound. Direction is required to search by TN or domain.
     *
     * @return self
     */
