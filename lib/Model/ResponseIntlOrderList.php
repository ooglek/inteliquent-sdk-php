...
/**
 * ResponseIntlOrderList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseIntlOrderList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlOrderList';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'order_list' => '\OpenAPI\Client\Model\ResponseIntlOrderListOrderList',
        'page' => 'string',
        'total_pages' => 'string',
        'total_items' => 'string'
    ];
     ...
     * Gets order_list
     *
     * @return \OpenAPI\Client\Model\ResponseIntlOrderListOrderList|null
     */
     ...
     * Sets order_list
     *
     * @param \OpenAPI\Client\Model\ResponseIntlOrderListOrderList|null $order_list order_list
     *
     * @return self
     */
