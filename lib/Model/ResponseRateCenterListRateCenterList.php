<?php
/**
 * ResponseRateCenterListRateCenterList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseRateCenterListRateCenterList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseRateCenterListRateCenterList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRateCenterList_rateCenterList';
    ...
    protected static $openAPITypes = [
        'rate_center_item' => '\OpenAPI\Client\Model\ResponseRateCenterListRateCenterListRateCenterItem[]'
    ];
    ...
    protected static $attributeMap = [
        'rate_center_item' => 'rateCenterItem'
    ];
    ...
    protected static $setters = [
        'rate_center_item' => 'setRateCenterItem'
    ];
    ...
    protected static $getters = [
        'rate_center_item' => 'getRateCenterItem'
    ];
    ...
    {
        $this->container['rate_center_item'] = $data['rate_center_item'] ?? null;
    }
    ...
    /**
     * Gets rate_center_item
     *
     * @return \OpenAPI\Client\Model\ResponseRateCenterListRateCenterListRateCenterItem[]|null
     */
    public function getRateCenterItem()
    {
        return $this->container['rate_center_item'];
    }

    /**
     * Sets rate_center_item
     *
     * @param \OpenAPI\Client\Model\ResponseRateCenterListRateCenterListRateCenterItem[]|null $rate_center_item rate_center_item
     *
     * @return self
     */
    public function setRateCenterItem($rate_center_item)
    {
        $this->container['rate_center_item'] = $rate_center_item;
