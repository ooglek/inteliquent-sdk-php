...
/**
 * InlineResponse40934 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40934 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_34';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(All Input Fields) | Invalid TN submitted:(Tn List)
     *
     * @return self
     */
