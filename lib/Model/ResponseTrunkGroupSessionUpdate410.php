<?php
/**
 * ResponseTrunkGroupSessionUpdate410
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTrunkGroupSessionUpdate410 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTrunkGroupSessionUpdate410 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTrunkGroupSessionUpdate410';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Request
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param string|null $status_code 410
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Detailed order status information
     *
     * @return self
     */
