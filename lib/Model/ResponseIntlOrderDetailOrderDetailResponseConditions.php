<?php
/**
 * ResponseIntlOrderDetailOrderDetailResponseConditions
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseIntlOrderDetailOrderDetailResponseConditions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseIntlOrderDetailOrderDetailResponseConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlOrderDetail_orderDetailResponse_conditions';
    ...
    protected static $openAPITypes = [
        'condition_type_ref' => 'string',
        'condition_name' => 'string',
        'document_status' => 'string',
        'document_status_ref' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'condition_type_ref' => null,
        'condition_name' => null,
        'document_status' => null,
        'document_status_ref' => null
    ];
    ...
    protected static $attributeMap = [
        'condition_type_ref' => 'conditionTypeRef',
        'condition_name' => 'conditionName',
        'document_status' => 'documentStatus',
        'document_status_ref' => 'documentStatusRef'
    ];
    ...
    protected static $setters = [
        'condition_type_ref' => 'setConditionTypeRef',
        'condition_name' => 'setConditionName',
        'document_status' => 'setDocumentStatus',
        'document_status_ref' => 'setDocumentStatusRef'
    ];
    ...
    protected static $getters = [
        'condition_type_ref' => 'getConditionTypeRef',
        'condition_name' => 'getConditionName',
        'document_status' => 'getDocumentStatus',
        'document_status_ref' => 'getDocumentStatusRef'
    ];
    ...
    {
        $this->container['condition_type_ref'] = $data['condition_type_ref'] ?? null;
        $this->container['condition_name'] = $data['condition_name'] ?? null;
        $this->container['document_status'] = $data['document_status'] ?? null;
        $this->container['document_status_ref'] = $data['document_status_ref'] ?? null;
    }
    ...
    /**
     * Gets condition_type_ref
     *
     * @return string|null
     */
    public function getConditionTypeRef()
    {
        return $this->container['condition_type_ref'];
    }

    /**
     * Sets condition_type_ref
     *
     * @param string|null $condition_type_ref condition_type_ref
     *
     * @return self
     */
    public function setConditionTypeRef($condition_type_ref)
    {
        $this->container['condition_type_ref'] = $condition_type_ref;
     ...
     * Sets condition_name
     *
     * @param string|null $condition_name condition_name
     *
     * @return self
     */
     ...
     *
     * @param string|null $document_status document_status
     *
     * @return self
     */
    ...
    /**
     * Gets document_status_ref
     *
     * @return string|null
     */
    public function getDocumentStatusRef()
    {
        return $this->container['document_status_ref'];
    }

    /**
     * Sets document_status_ref
     *
     * @param string|null $document_status_ref document_status_ref
     *
     * @return self
     */
    public function setDocumentStatusRef($document_status_ref)
    {
        $this->container['document_status_ref'] = $document_status_ref;
