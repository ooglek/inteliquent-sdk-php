 ...
 */
class TfDnoTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfDno_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TfDnoTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TfDnoTnListTnItem[]
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TfDnoTnListTnItem[] $tn_item Contains active toll free number(s) to update
     *
     * @return self
     */
