...
/**
 * TnNoteUpdateTnNoteTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active telephone number(s) to add note(s)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnNoteUpdateTnNoteTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnNoteUpdate_tnNote_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TnNoteUpdateTnNoteTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TnNoteUpdateTnNoteTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TnNoteUpdateTnNoteTnListTnItem[]|null $tn_item Contains active telephone number(s) to add note(s)
     *
     * @return self
     */
