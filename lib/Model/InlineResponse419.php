...
/**
 * InlineResponse419 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse419 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_419';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 419
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Error Occurred:Account not message-enabled, remove messaging from request
     *
     * @return self
     */
