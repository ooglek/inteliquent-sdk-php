<?php
/**
 * WhitelistedAddressResultPostalAddress
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * WhitelistedAddressResultPostalAddress Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WhitelistedAddressResultPostalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhitelistedAddress_result_postalAddress';
     ...
     * Sets address_line1
     *
     * @param string|null $address_line1 House Number.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city Street Name.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state Stree Suffix.
     *
     * @return self
     */
     ...
     * Sets zip
     *
     * @param string|null $zip Street Post Directional.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country City.
     *
     * @return self
     */
