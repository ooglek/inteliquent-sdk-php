...
/**
 * ResponseIntlConditionList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseIntlConditionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlConditionList';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'conditions' => '\OpenAPI\Client\Model\ResponseIntlConditionListConditions[]'
    ];
     ...
     * Gets conditions
     *
     * @return \OpenAPI\Client\Model\ResponseIntlConditionListConditions[]|null
     */
     ...
     * Sets conditions
     *
     * @param \OpenAPI\Client\Model\ResponseIntlConditionListConditions[]|null $conditions Encompassing object that holds condition list
     *
     * @return self
     */
