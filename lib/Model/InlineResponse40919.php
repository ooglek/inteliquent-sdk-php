...
class InlineResponse40919 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(Input Fields) | Invalid TN submitted | E911:Invalid origStreetInfo (# is not allowed) submitted for TN/s |CustomerOrderReference has invalid characters and cannot include <, \\\\, ^, ~, `, }, {, >, =, ], [, !
     *
     * @return self
     */
