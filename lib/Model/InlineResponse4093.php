...
class InlineResponse4093 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(All Input Fields) | Invalid messagingBrandId format, should start with B and contain alphanumeric characters only |  Invalid externalCampaignId format | externalCampaignId is not ACTIVE |  externalCampaignId is not registered
     *
     * @return self
     */
