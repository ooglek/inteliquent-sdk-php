...
/**
 * InlineResponse40824 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40824 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_408_24';
     ...
     * Sets status
     *
     * @param string|null $status Private Key cannot be blank. | orderNote must not exceed 4000 characters.
     *
     * @return self
     */
