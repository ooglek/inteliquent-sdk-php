...
/**
 * InlineResponse41419 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41419 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_19';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) |  Large result set without searchId detected. Please contact support team for assistance.
     *
     * @return self
     */
