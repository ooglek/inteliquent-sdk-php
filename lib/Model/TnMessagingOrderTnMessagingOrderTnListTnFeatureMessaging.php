<?php
/**
 * TnMessagingOrderTnMessagingOrderTnListTnFeatureMessaging
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnMessagingOrderTnMessagingOrderTnListTnFeatureMessaging Class Doc Comment
 *
 * @category Class
 * @description Text messaging services for the telephone number
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnMessagingOrderTnMessagingOrderTnListTnFeatureMessaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnMessagingOrder_tnMessagingOrder_tnList_tnFeature_messaging';
