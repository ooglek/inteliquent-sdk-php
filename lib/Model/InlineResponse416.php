...
/**
 * InlineResponse416 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse416 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_416';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 416
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status These values can't be zero:troubleTicketId
     *
     * @return self
     */
