...
/**
 * InlineResponse4106 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4106 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410_6';
     ...
     * Sets status
     *
     * @param string|null $status Primary private key is required | Required fields not sent | Private key is required | Can not delete primary key. Make another key as primary first
     *
     * @return self
     */
