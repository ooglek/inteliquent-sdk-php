...
/**
 * InlineResponse41420 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41420 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_20';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Field Required- messaging for TNs | Toll Free Messaging is not enabled
     *
     * @return self
     */
