...
/**
 * InlineResponse41016 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41016 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410_16';
     ...
     * Sets status
     *
     * @param string|null $status (Web Request Error Message)
     *
     * @return self
     */
