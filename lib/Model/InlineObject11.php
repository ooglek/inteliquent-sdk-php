...
class InlineObject11 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['advanced_call_route_plan_id'] === null) {
            $invalidProperties[] = "'advanced_call_route_plan_id' can't be null";
        }
     ...
     *
     * @param int $advanced_call_route_plan_id Id for advanced call route plan id
     *
     * @return self
     */
