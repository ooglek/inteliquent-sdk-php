...
/**
 * InlineResponse450 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse450 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_450';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 450
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Couldn't parse the input date
     *
     * @return self
     */
