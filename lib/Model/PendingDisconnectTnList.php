...
/**
 * PendingDisconnectTnList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PendingDisconnectTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PendingDisconnectTnList';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'tn_list' => '\OpenAPI\Client\Model\PendingDisconnectTnListTnList'
    ];
     ...
     * Gets tn_list
     *
     * @return \OpenAPI\Client\Model\PendingDisconnectTnListTnList|null
     */
     ...
     * Sets tn_list
     *
     * @param \OpenAPI\Client\Model\PendingDisconnectTnListTnList|null $tn_list tn_list
     *
     * @return self
     */
