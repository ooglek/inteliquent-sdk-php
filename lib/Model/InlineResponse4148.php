...
/**
 * InlineResponse4148 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4148 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_8';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Field Required- messaging for TNs | Field Required- tnFeature for TNs
     *
     * @return self
     */
