<?php
/**
 * ResponseAvailableActivationList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseAvailableActivationList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseAvailableActivationList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAvailableActivationList';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'available_activation_list' => '\OpenAPI\Client\Model\ResponseAvailableActivationListAvailableActivationList[]'
    ];
    ...
    protected static $openAPIFormats = [
        'status' => null,
        'status_code' => null,
        'available_activation_list' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'available_activation_list' => 'availableActivationList'
    ];
    ...
    protected static $setters = [
        ...
        'available_activation_list' => 'setAvailableActivationList'
    ];
    ...
    protected static $getters = [
        ...
        'available_activation_list' => 'getAvailableActivationList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['available_activation_list'] = $data['available_activation_list'] ?? null;
    }
    ...
    /**
     * Gets available_activation_list
     *
     * @return \OpenAPI\Client\Model\ResponseAvailableActivationListAvailableActivationList[]|null
     */
    public function getAvailableActivationList()
    {
        return $this->container['available_activation_list'];
    }

    /**
     * Sets available_activation_list
     *
     * @param \OpenAPI\Client\Model\ResponseAvailableActivationListAvailableActivationList[]|null $available_activation_list available_activation_list
     *
     * @return self
     */
    public function setAvailableActivationList($available_activation_list)
    {
        $this->container['available_activation_list'] = $available_activation_list;
