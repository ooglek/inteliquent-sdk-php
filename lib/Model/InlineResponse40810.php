...
/**
 * InlineResponse40810 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40810 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_408_10';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 408
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Error text listing the actual error that occured  | Private Key cannot be blank.| orderNote must not exceed 4000 characters.
     *
     * @return self
     */
