...
/**
 * InlineResponse4182 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4182 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_418_2';
     ...
     * Sets status
     *
     * @param string|null $status Character limit is exceeded for:CustomerOrderReference | Character limit is exceeded for:resellerName
     *
     * @return self
     */
