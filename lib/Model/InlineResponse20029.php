...
class InlineResponse20029 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'string',
        'status' => 'string',
        'tf_forward_list' => '\OpenAPI\Client\Model\InlineResponse20028TnForwardList[]'
    ];
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'tf_forward_list' => 'setTfForwardList'
    ];
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'tf_forward_list' => 'getTfForwardList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tf_forward_list'] = $data['tf_forward_list'] ?? null;
    }
    ...
    /**
     * Gets tf_forward_list
     *
     * @return \OpenAPI\Client\Model\InlineResponse20028TnForwardList[]|null
     */
    public function getTfForwardList()
    {
        return $this->container['tf_forward_list'];
    }

    /**
     * Sets tf_forward_list
     *
     * @param \OpenAPI\Client\Model\InlineResponse20028TnForwardList[]|null $tf_forward_list Contains list of  telephone number(s) with forwardTo
     *
     * @return self
     */
    public function setTfForwardList($tf_forward_list)
    {
        $this->container['tf_forward_list'] = $tf_forward_list;
