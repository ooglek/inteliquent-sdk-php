<?php
/**
 * RemoveAuthorizationAuthorizations
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * RemoveAuthorizationAuthorizations Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RemoveAuthorizationAuthorizations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_removeAuthorization_authorizations';
     ...
     * Sets auth_id
     *
     * @param string $auth_id ID associated to the API key or webhook to be removed (as retrieved from selectAuthorization)
     *
     * @return self
     */
