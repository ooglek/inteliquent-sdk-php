<?php
/**
 * BrandOrderDetailBrandOrderDetailResponseOrderNotes
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * BrandOrderDetailBrandOrderDetailResponseOrderNotes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BrandOrderDetailBrandOrderDetailResponseOrderNotes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandOrderDetail_brandOrderDetailResponse_orderNotes';
     ...
     * Sets note
     *
     * @param string|null $note Note description
     *
     * @return self
     */
     ...
     * Sets insert_date
     *
     * @param \DateTime|null $insert_date Date the note was entered
     *
     * @return self
     */
     ...
     * Sets insert_user
     *
     * @param string|null $insert_user The user that created the note
     *
     * @return self
     */
