...
/**
 * InlineResponse41415 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41415 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_15';
     ...
     * Sets status
     *
     * @param string|null $status Error text listing the actual error that occured | Fields Are Required:(All Required Fields) | Csr Lookup is not allowed for customer
     *
     * @return self
     */
