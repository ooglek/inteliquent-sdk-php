<?php
/**
 * ResponseAccountDefaultDetailAccountDefaultDetailPortOutContactList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseAccountDefaultDetailAccountDefaultDetailPortOutContactList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseAccountDefaultDetailAccountDefaultDetailPortOutContactList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAccountDefaultDetail_accountDefaultDetail_portOutContactList';
    ...
    protected static $openAPITypes = [
        'port_out_contact_item' => '\OpenAPI\Client\Model\ResponseAccountDefaultDetailAccountDefaultDetailPortOutContactListPortOutContactItem[]'
    ];
    ...
    protected static $attributeMap = [
        'port_out_contact_item' => 'portOutContactItem'
    ];
    ...
    protected static $setters = [
        'port_out_contact_item' => 'setPortOutContactItem'
    ];
    ...
    protected static $getters = [
        'port_out_contact_item' => 'getPortOutContactItem'
    ];
    ...
    {
        $this->container['port_out_contact_item'] = $data['port_out_contact_item'] ?? null;
    }
    ...
    /**
     * Gets port_out_contact_item
     *
     * @return \OpenAPI\Client\Model\ResponseAccountDefaultDetailAccountDefaultDetailPortOutContactListPortOutContactItem[]|null
     */
    public function getPortOutContactItem()
    {
        return $this->container['port_out_contact_item'];
    }

    /**
     * Sets port_out_contact_item
     *
     * @param \OpenAPI\Client\Model\ResponseAccountDefaultDetailAccountDefaultDetailPortOutContactListPortOutContactItem[]|null $port_out_contact_item port_out_contact_item
     *
     * @return self
     */
    public function setPortOutContactItem($port_out_contact_item)
    {
        $this->container['port_out_contact_item'] = $port_out_contact_item;
