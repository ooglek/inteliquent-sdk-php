...
/**
 * InlineResponse41417 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41417 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_17';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | ciclist for TN:(Tn List) |  routingLabel for TNs:(Tn List) | Toll Free Messaging is not enabled
     *
     * @return self
     */
