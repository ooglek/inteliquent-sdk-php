...
/**
 * AlternateBusinessIdTypeList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AlternateBusinessIdTypeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlternateBusinessIdTypeList';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'messaging_brand_alternate_business_id_types' => '\OpenAPI\Client\Model\AlternateBusinessIdTypeListMessagingBrandAlternateBusinessIdTypes[]'
    ];
    ...
    protected static $openAPIFormats = [
        'status' => null,
        'status_code' => null,
        'messaging_brand_alternate_business_id_types' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'messaging_brand_alternate_business_id_types' => 'messagingBrandAlternateBusinessIdTypes'
    ];
    ...
    protected static $setters = [
        ...
        'messaging_brand_alternate_business_id_types' => 'setMessagingBrandAlternateBusinessIdTypes'
    ];
    ...
    protected static $getters = [
        ...
        'messaging_brand_alternate_business_id_types' => 'getMessagingBrandAlternateBusinessIdTypes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['messaging_brand_alternate_business_id_types'] = $data['messaging_brand_alternate_business_id_types'] ?? null;
    }
    ...
    /**
     * Gets messaging_brand_alternate_business_id_types
     *
     * @return \OpenAPI\Client\Model\AlternateBusinessIdTypeListMessagingBrandAlternateBusinessIdTypes[]|null
     */
    public function getMessagingBrandAlternateBusinessIdTypes()
    {
        return $this->container['messaging_brand_alternate_business_id_types'];
    }

    /**
     * Sets messaging_brand_alternate_business_id_types
     *
     * @param \OpenAPI\Client\Model\AlternateBusinessIdTypeListMessagingBrandAlternateBusinessIdTypes[]|null $messaging_brand_alternate_business_id_types messaging_brand_alternate_business_id_types
     *
     * @return self
     */
    public function setMessagingBrandAlternateBusinessIdTypes($messaging_brand_alternate_business_id_types)
    {
        $this->container['messaging_brand_alternate_business_id_types'] = $messaging_brand_alternate_business_id_types;
