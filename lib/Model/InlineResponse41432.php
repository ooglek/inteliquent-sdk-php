...
/**
 * InlineResponse41432 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41432 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_32';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:<name Of Field> | TN is Invalid
     *
     * @return self
     */
