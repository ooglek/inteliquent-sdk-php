...
/**
 * LataInventoryTnList Class Doc Comment
 *
 * @category Class
 * @description Contains requested telephone number(s) to retrieve LATA information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LataInventoryTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_lataInventory_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\LataInventoryTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\LataInventoryTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\LataInventoryTnListTnItem[]|null $tn_item Contains requested telephone number(s)
     *
     * @return self
     */
