...
/**
 * PortInOrderList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInOrderList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInOrderList';
    ...
    protected static $openAPITypes = [
        ...
        'total_items' => 'string',
        'search_id' => 'string',
        'order_list' => '\OpenAPI\Client\Model\PortInOrderListOrderList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['order_list'] = $data['order_list'] ?? null;
    }
     ...
     * Sets search_id
     *
     * @param string|null $search_id searchId can be used as iterator, it will be returned in every response of this api. You will be able to use this parameter, only if you are receiving it in response
     *
     * @return self
     */
     ...
     * Gets order_list
     *
     * @return \OpenAPI\Client\Model\PortInOrderListOrderList|null
     */
     ...
     * Sets order_list
     *
     * @param \OpenAPI\Client\Model\PortInOrderListOrderList|null $order_list order_list
     *
     * @return self
     */
