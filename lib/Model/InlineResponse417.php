...
/**
 * InlineResponse417 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse417 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_417';
     ...
     * Sets status
     *
     * @param string|null $status Quantity must be less than 10000
     *
     * @return self
     */
