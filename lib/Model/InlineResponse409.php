...
class InlineResponse409 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:sortDirection can be either ASC or DES | CustomerOrderReference has invalid characters and cannot include <, \\\\, ^, ~, `, }, {, >, =, ], [, !
     *
     * @return self
     */
