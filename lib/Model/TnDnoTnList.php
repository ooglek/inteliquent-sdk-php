 ...
 */
class TnDnoTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnDno_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TnDnoTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TnDnoTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TnDnoTnListTnItem[]|null $tn_item Contains active telephone number(s) to update dno
     *
     * @return self
     */
