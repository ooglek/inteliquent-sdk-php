<?php
/**
 * TnPortOutRejectTnPortOutReject
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnPortOutRejectTnPortOutReject Class Doc Comment
 *
 * @category Class
 * @description Contains TN information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnPortOutRejectTnPortOutReject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnPortOutReject_tnPortOutReject';
    ...
    const REJECT_REASON_PIN = 'PIN';
    const REJECT_REASON_DATAMIS = 'DATAMIS';
    const REJECT_REASON_AUTHNMMIS = 'AUTHNMMIS';
    const REJECT_REASON_INVACCT = 'INVACCT';
    const REJECT_REASON_INVZIPCD = 'INVZIPCD';
    ...
    {
        return [
            self::REJECT_REASON_PIN,
            self::REJECT_REASON_DATAMIS,
            self::REJECT_REASON_AUTHNMMIS,
            self::REJECT_REASON_INVACCT,
            self::REJECT_REASON_INVZIPCD,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['reject_reason']) && !in_array($this->container['reject_reason'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'reject_reason', must be one of '%s'",
                $this->container['reject_reason'],
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit telephone number
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getRejectReasonAllowableValues();
        if (!is_null($reject_reason) && !in_array($reject_reason, $allowedValues, true)) {
