...
/**
 * InlineResponse4109 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4109 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410_9';
     ...
     * Sets status
     *
     * @param string|null $status Error specific to order_id or customerOrderReference are not valid or unique  | DB Error:(Database Error)
     *
     * @return self
     */
