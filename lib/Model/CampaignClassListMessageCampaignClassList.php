<?php
/**
 * CampaignClassListMessageCampaignClassList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CampaignClassListMessageCampaignClassList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignClassListMessageCampaignClassList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignClassList_messageCampaignClassList';
    ...
    protected static $openAPITypes = [
        'message_campaign_class_item' => '\OpenAPI\Client\Model\CampaignClassListMessageCampaignClassListMessageCampaignClassItem[]'
    ];
    ...
    protected static $openAPIFormats = [
        'message_campaign_class_item' => null
    ];
    ...
    protected static $attributeMap = [
        'message_campaign_class_item' => 'messageCampaignClassItem'
    ];
    ...
    protected static $setters = [
        'message_campaign_class_item' => 'setMessageCampaignClassItem'
    ];
    ...
    protected static $getters = [
        'message_campaign_class_item' => 'getMessageCampaignClassItem'
    ];
    ...
    {
        $this->container['message_campaign_class_item'] = $data['message_campaign_class_item'] ?? null;
    }
    ...
    /**
     * Gets message_campaign_class_item
     *
     * @return \OpenAPI\Client\Model\CampaignClassListMessageCampaignClassListMessageCampaignClassItem[]|null
     */
    public function getMessageCampaignClassItem()
    {
        return $this->container['message_campaign_class_item'];
    }

    /**
     * Sets message_campaign_class_item
     *
     * @param \OpenAPI\Client\Model\CampaignClassListMessageCampaignClassListMessageCampaignClassItem[]|null $message_campaign_class_item message_campaign_class_item
     *
     * @return self
     */
    public function setMessageCampaignClassItem($message_campaign_class_item)
    {
        $this->container['message_campaign_class_item'] = $message_campaign_class_item;
