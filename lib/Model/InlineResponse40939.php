...
/**
 * InlineResponse40939 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40939 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_39';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(Required Fields)
     *
     * @return self
     */
