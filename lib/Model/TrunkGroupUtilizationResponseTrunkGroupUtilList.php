<?php
/**
 * TrunkGroupUtilizationResponseTrunkGroupUtilList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupUtilizationResponseTrunkGroupUtilList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrunkGroupUtilizationResponseTrunkGroupUtilList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrunkGroupUtilizationResponse_trunkGroupUtilList';
    ...
    protected static $openAPITypes = [
        'trunk_group_util_item' => '\OpenAPI\Client\Model\TrunkGroupUtilizationResponseTrunkGroupUtilListTrunkGroupUtilItem[]'
    ];
    ...
    protected static $attributeMap = [
        'trunk_group_util_item' => 'trunkGroupUtilItem'
    ];
    ...
    protected static $setters = [
        'trunk_group_util_item' => 'setTrunkGroupUtilItem'
    ];
    ...
    protected static $getters = [
        'trunk_group_util_item' => 'getTrunkGroupUtilItem'
    ];
    ...
    {
        $this->container['trunk_group_util_item'] = $data['trunk_group_util_item'] ?? null;
    }
    ...
    /**
     * Gets trunk_group_util_item
     *
     * @return \OpenAPI\Client\Model\TrunkGroupUtilizationResponseTrunkGroupUtilListTrunkGroupUtilItem[]|null
     */
    public function getTrunkGroupUtilItem()
    {
        return $this->container['trunk_group_util_item'];
    }

    /**
     * Sets trunk_group_util_item
     *
     * @param \OpenAPI\Client\Model\TrunkGroupUtilizationResponseTrunkGroupUtilListTrunkGroupUtilItem[]|null $trunk_group_util_item trunk_group_util_item
     *
     * @return self
     */
    public function setTrunkGroupUtilItem($trunk_group_util_item)
    {
        $this->container['trunk_group_util_item'] = $trunk_group_util_item;
