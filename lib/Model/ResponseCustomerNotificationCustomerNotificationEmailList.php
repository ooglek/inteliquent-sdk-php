<?php
/**
 * ResponseCustomerNotificationCustomerNotificationEmailList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseCustomerNotificationCustomerNotificationEmailList Class Doc Comment
 *
 * @category Class
 * @description Contains email list - This element may not be set if there are no notification emails setup for the customer
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseCustomerNotificationCustomerNotificationEmailList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCustomerNotification_customerNotification_emailList';
    ...
    protected static $openAPITypes = [
        'email_item' => '\OpenAPI\Client\Model\ResponseCustomerNotificationCustomerNotificationEmailListEmailItem[]'
    ];
    ...
    {
        $this->container['email_item'] = $data['email_item'] ?? null;
    }
     ...
     * Gets email_item
     *
     * @return \OpenAPI\Client\Model\ResponseCustomerNotificationCustomerNotificationEmailListEmailItem[]|null
     */
    public function getEmailItem()
    {
        return $this->container['email_item'];
    }

    /**
     * Sets email_item
     *
     * @param \OpenAPI\Client\Model\ResponseCustomerNotificationCustomerNotificationEmailListEmailItem[]|null $email_item Contains email List
     *
     * @return self
     */
    public function setEmailItem($email_item)
    {
        $this->container['email_item'] = $email_item;
