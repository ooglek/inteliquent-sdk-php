<?php
/**
 * VerticalListMessagingBrandVerticals
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * VerticalListMessagingBrandVerticals Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerticalListMessagingBrandVerticals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerticalList_messagingBrandVerticals';
    ...
    protected static $openAPITypes = [
        'brand_vertical_ref' => 'string',
        'brand_vertical_name' => 'string',
        'abbreviation' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'brand_vertical_ref' => null,
        'brand_vertical_name' => null,
        'abbreviation' => null
    ];
    ...
    protected static $attributeMap = [
        'brand_vertical_ref' => 'brandVerticalRef',
        'brand_vertical_name' => 'brandVerticalName',
    ...
    protected static $setters = [
        'brand_vertical_ref' => 'setBrandVerticalRef',
        'brand_vertical_name' => 'setBrandVerticalName',
    ...
    protected static $getters = [
        'brand_vertical_ref' => 'getBrandVerticalRef',
        'brand_vertical_name' => 'getBrandVerticalName',
    ...
    {
        $this->container['brand_vertical_ref'] = $data['brand_vertical_ref'] ?? null;
        $this->container['brand_vertical_name'] = $data['brand_vertical_name'] ?? null;
    ...
    /**
     * Gets brand_vertical_ref
     *
     * @return string|null
     */
    public function getBrandVerticalRef()
    {
        return $this->container['brand_vertical_ref'];
    }

    /**
     * Sets brand_vertical_ref
     *
     * @param string|null $brand_vertical_ref Brand vertical reference.
     *
     * @return self
     */
    public function setBrandVerticalRef($brand_vertical_ref)
    {
        $this->container['brand_vertical_ref'] = $brand_vertical_ref;

        return $this;
    }

    /**
     * Gets brand_vertical_name
     *
     * @return string|null
     */
    public function getBrandVerticalName()
    {
        return $this->container['brand_vertical_name'];
    }

    /**
     * Sets brand_vertical_name
     *
     * @param string|null $brand_vertical_name Vertical name
     *
     * @return self
     */
    public function setBrandVerticalName($brand_vertical_name)
    {
        $this->container['brand_vertical_name'] = $brand_vertical_name;
     ...
     * Sets abbreviation
     *
     * @param string|null $abbreviation Vertical abbreviation.
     *
     * @return self
     */
