 ...
 */
class InlineResponse410 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_410';
     ...
     * Sets status
     *
     * @param string|null $status DB Error:(Database Error)
     *
     * @return self
     */
