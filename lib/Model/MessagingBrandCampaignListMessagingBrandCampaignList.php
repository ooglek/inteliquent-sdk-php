<?php
/**
 * MessagingBrandCampaignListMessagingBrandCampaignList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * MessagingBrandCampaignListMessagingBrandCampaignList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagingBrandCampaignListMessagingBrandCampaignList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagingBrandCampaignList_messagingBrandCampaignList';
    ...
    protected static $openAPITypes = [
        'messaging_brand_campaign_item' => '\OpenAPI\Client\Model\MessagingBrandCampaignListMessagingBrandCampaignListMessagingBrandCampaignItem[]'
    ];
    ...
    protected static $openAPIFormats = [
        'messaging_brand_campaign_item' => null
    ];
    ...
    protected static $attributeMap = [
        'messaging_brand_campaign_item' => 'messagingBrandCampaignItem'
    ];
    ...
    protected static $setters = [
        'messaging_brand_campaign_item' => 'setMessagingBrandCampaignItem'
    ];
    ...
    protected static $getters = [
        'messaging_brand_campaign_item' => 'getMessagingBrandCampaignItem'
    ];
    ...
    {
        $this->container['messaging_brand_campaign_item'] = $data['messaging_brand_campaign_item'] ?? null;
    }
    ...
    /**
     * Gets messaging_brand_campaign_item
     *
     * @return \OpenAPI\Client\Model\MessagingBrandCampaignListMessagingBrandCampaignListMessagingBrandCampaignItem[]|null
     */
    public function getMessagingBrandCampaignItem()
    {
        return $this->container['messaging_brand_campaign_item'];
    }

    /**
     * Sets messaging_brand_campaign_item
     *
     * @param \OpenAPI\Client\Model\MessagingBrandCampaignListMessagingBrandCampaignListMessagingBrandCampaignItem[]|null $messaging_brand_campaign_item messaging_brand_campaign_item
     *
     * @return self
     */
    public function setMessagingBrandCampaignItem($messaging_brand_campaign_item)
    {
        $this->container['messaging_brand_campaign_item'] = $messaging_brand_campaign_item;
