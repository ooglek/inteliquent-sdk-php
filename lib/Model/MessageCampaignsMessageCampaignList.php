<?php
/**
 * MessageCampaignsMessageCampaignList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * MessageCampaignsMessageCampaignList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessageCampaignsMessageCampaignList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageCampaigns_messageCampaignList';
    ...
    protected static $openAPITypes = [
        'message_campaign_item' => '\OpenAPI\Client\Model\MessageCampaignsMessageCampaignListMessageCampaignItem[]'
    ];
    ...
    protected static $attributeMap = [
        'message_campaign_item' => 'messageCampaignItem'
    ];
    ...
    protected static $setters = [
        'message_campaign_item' => 'setMessageCampaignItem'
    ];
    ...
    protected static $getters = [
        'message_campaign_item' => 'getMessageCampaignItem'
    ];
    ...
    {
        $this->container['message_campaign_item'] = $data['message_campaign_item'] ?? null;
    }
    ...
    /**
     * Gets message_campaign_item
     *
     * @return \OpenAPI\Client\Model\MessageCampaignsMessageCampaignListMessageCampaignItem[]|null
     */
    public function getMessageCampaignItem()
    {
        return $this->container['message_campaign_item'];
    }

    /**
     * Sets message_campaign_item
     *
     * @param \OpenAPI\Client\Model\MessageCampaignsMessageCampaignListMessageCampaignItem[]|null $message_campaign_item message_campaign_item
     *
     * @return self
     */
    public function setMessageCampaignItem($message_campaign_item)
    {
        $this->container['message_campaign_item'] = $message_campaign_item;
