<?php
/**
 * PortInOrderListOrderListOrderType
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PortInOrderListOrderListOrderType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInOrderListOrderListOrderType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInOrderList_orderList_orderType';
    ...
    protected static $openAPITypes = [
        ...
        'tn_quantity' => 'int',
        'foc_tn_quantity' => 'int',
        'rejected_tn_quantity' => 'int',
        'activated_tn_quantity' => 'int',
        'foc_list' => '\OpenAPI\Client\Model\PortInOrderListOrderListFocList',
        'reject_reason_list' => '\OpenAPI\Client\Model\PortInOrderListOrderListRejectReasonList'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'tn_quantity' => null,
        'foc_tn_quantity' => null,
        'rejected_tn_quantity' => null,
        'activated_tn_quantity' => null,
        'foc_list' => null,
    ...
    protected static $attributeMap = [
        ...
        'foc_tn_quantity' => 'focTnQuantity',
        'rejected_tn_quantity' => 'rejectedTnQuantity',
        'activated_tn_quantity' => 'activatedTnQuantity',
        'foc_list' => 'focList',
        'reject_reason_list' => 'rejectReasonList'
    ];
    ...
    protected static $setters = [
        ...
        'foc_tn_quantity' => 'setFocTnQuantity',
        'rejected_tn_quantity' => 'setRejectedTnQuantity',
        'activated_tn_quantity' => 'setActivatedTnQuantity',
        'foc_list' => 'setFocList',
        'reject_reason_list' => 'setRejectReasonList'
    ];
    ...
    protected static $getters = [
        ...
        'foc_tn_quantity' => 'getFocTnQuantity',
        'rejected_tn_quantity' => 'getRejectedTnQuantity',
        'activated_tn_quantity' => 'getActivatedTnQuantity',
        'foc_list' => 'getFocList',
        'reject_reason_list' => 'getRejectReasonList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['foc_tn_quantity'] = $data['foc_tn_quantity'] ?? null;
        $this->container['rejected_tn_quantity'] = $data['rejected_tn_quantity'] ?? null;
        $this->container['activated_tn_quantity'] = $data['activated_tn_quantity'] ?? null;
        $this->container['foc_list'] = $data['foc_list'] ?? null;
        $this->container['reject_reason_list'] = $data['reject_reason_list'] ?? null;
    }
    ...
    /**
     * Gets foc_tn_quantity
     *
     * @return int|null
     */
    public function getFocTnQuantity()
    {
        return $this->container['foc_tn_quantity'];
    }

    /**
     * Sets foc_tn_quantity
     *
     * @param int|null $foc_tn_quantity foc_tn_quantity
     *
     * @return self
     */
    public function setFocTnQuantity($foc_tn_quantity)
    {
        $this->container['foc_tn_quantity'] = $foc_tn_quantity;

        return $this;
    }

    /**
     * Gets rejected_tn_quantity
     *
     * @return int|null
     */
    public function getRejectedTnQuantity()
    {
        return $this->container['rejected_tn_quantity'];
    }

    /**
     * Sets rejected_tn_quantity
     *
     * @param int|null $rejected_tn_quantity rejected_tn_quantity
     *
     * @return self
     */
    public function setRejectedTnQuantity($rejected_tn_quantity)
    {
        $this->container['rejected_tn_quantity'] = $rejected_tn_quantity;

        return $this;
    }

    /**
     * Gets activated_tn_quantity
     *
     * @return int|null
     */
    public function getActivatedTnQuantity()
    {
        return $this->container['activated_tn_quantity'];
    }

    /**
     * Sets activated_tn_quantity
     *
     * @param int|null $activated_tn_quantity activated_tn_quantity
     *
     * @return self
     */
    public function setActivatedTnQuantity($activated_tn_quantity)
    {
        $this->container['activated_tn_quantity'] = $activated_tn_quantity;
     ...
     * Gets foc_list
     *
     * @return \OpenAPI\Client\Model\PortInOrderListOrderListFocList|null
     */
    public function getFocList()
    {
        return $this->container['foc_list'];
    }

    /**
     * Sets foc_list
     *
     * @param \OpenAPI\Client\Model\PortInOrderListOrderListFocList|null $foc_list foc_list
     *
     * @return self
     */
    public function setFocList($foc_list)
    {
        $this->container['foc_list'] = $foc_list;

        return $this;
    }

    /**
     * Gets reject_reason_list
     *
     * @return \OpenAPI\Client\Model\PortInOrderListOrderListRejectReasonList|null
     */
    public function getRejectReasonList()
    {
        return $this->container['reject_reason_list'];
    }

    /**
     * Sets reject_reason_list
     *
     * @param \OpenAPI\Client\Model\PortInOrderListOrderListRejectReasonList|null $reject_reason_list reject_reason_list
     *
     * @return self
     */
    public function setRejectReasonList($reject_reason_list)
    {
        $this->container['reject_reason_list'] = $reject_reason_list;
