<?php
/**
 * ResponseIntlTnAddDocumentIntlTnDocumentResponseTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseIntlTnAddDocumentIntlTnDocumentResponseTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseIntlTnAddDocumentIntlTnDocumentResponseTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseIntlTnAddDocument_intlTnDocumentResponse_tnList_tnItem';
    ...
    protected static $openAPITypes = [
        'tn' => 'string',
        'documents' => '\OpenAPI\Client\Model\ResponseIntlTnAddDocumentIntlTnDocumentResponseTnListTnItemDocuments'
    ];
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\Model\ResponseIntlTnAddDocumentIntlTnDocumentResponseTnListTnItemDocuments|null
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\Model\ResponseIntlTnAddDocumentIntlTnDocumentResponseTnListTnItemDocuments|null $documents documents
     *
     * @return self
     */
