...
/**
 * InlineResponse4171 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4171 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_417_1';
     ...
     * Sets status
     *
     * @param string|null $status Size must be less than or equal to 10000
     *
     * @return self
     */
