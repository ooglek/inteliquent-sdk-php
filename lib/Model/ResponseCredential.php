...
/**
 * ResponseCredential Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCredential implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCredential';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_code' => 'string',
        'credential' => '\OpenAPI\Client\Model\ResponseCredentialCredential'
    ];
     ...
     * Gets credential
     *
     * @return \OpenAPI\Client\Model\ResponseCredentialCredential|null
     */
     ...
     * Sets credential
     *
     * @param \OpenAPI\Client\Model\ResponseCredentialCredential|null $credential credential
     *
     * @return self
     */
