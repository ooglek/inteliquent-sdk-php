<?php
/**
 * ResponseAddressValidateAddressValidateResponsePsap
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseAddressValidateAddressValidateResponsePsap Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseAddressValidateAddressValidateResponsePsap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAddressValidate_addressValidateResponse_psap';
    ...
    protected static $openAPITypes = [
        'psap_name' => 'string',
        'psap_fcc_id' => 'string',
        'psap_admin_number' => 'string',
        'psap_voip_service_level' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'psap_name' => null,
        'psap_fcc_id' => null,
        'psap_admin_number' => null,
        'psap_voip_service_level' => null
    ];
    ...
    protected static $attributeMap = [
        'psap_name' => 'psapName',
        'psap_fcc_id' => 'psapFccId',
        'psap_admin_number' => 'psapAdminNumber',
        'psap_voip_service_level' => 'psapVoipServiceLevel'
    ];
    ...
    protected static $setters = [
        'psap_name' => 'setPsapName',
        'psap_fcc_id' => 'setPsapFccId',
        'psap_admin_number' => 'setPsapAdminNumber',
        'psap_voip_service_level' => 'setPsapVoipServiceLevel'
    ];
    ...
    protected static $getters = [
        'psap_name' => 'getPsapName',
        'psap_fcc_id' => 'getPsapFccId',
        'psap_admin_number' => 'getPsapAdminNumber',
        'psap_voip_service_level' => 'getPsapVoipServiceLevel'
    ];
    ...
    {
        $this->container['psap_name'] = $data['psap_name'] ?? null;
        $this->container['psap_fcc_id'] = $data['psap_fcc_id'] ?? null;
        $this->container['psap_admin_number'] = $data['psap_admin_number'] ?? null;
        $this->container['psap_voip_service_level'] = $data['psap_voip_service_level'] ?? null;
    }
     ...
     * @return string|null
     */
    public function getPsapName()
    {
        return $this->container['psap_name'];
    }

    /**
     * Sets psap_name
     *
     * @param string|null $psap_name psap_name
     *
     * @return self
     */
    public function setPsapName($psap_name)
    {
        $this->container['psap_name'] = $psap_name;
     ...
     * @return string|null
     */
    public function getPsapFccId()
    {
        return $this->container['psap_fcc_id'];
    }

    /**
     * Sets psap_fcc_id
     *
     * @param string|null $psap_fcc_id psap_fcc_id
     *
     * @return self
     */
    public function setPsapFccId($psap_fcc_id)
    {
        $this->container['psap_fcc_id'] = $psap_fcc_id;

        return $this;
    }

    /**
     * Gets psap_admin_number
     *
     * @return string|null
     */
    public function getPsapAdminNumber()
    {
        return $this->container['psap_admin_number'];
    }

    /**
     * Sets psap_admin_number
     *
     * @param string|null $psap_admin_number psap_admin_number
     *
     * @return self
     */
    public function setPsapAdminNumber($psap_admin_number)
    {
        $this->container['psap_admin_number'] = $psap_admin_number;

        return $this;
    }

    /**
     * Gets psap_voip_service_level
     *
     * @return string|null
     */
    public function getPsapVoipServiceLevel()
    {
        return $this->container['psap_voip_service_level'];
    }

    /**
     * Sets psap_voip_service_level
     *
     * @param string|null $psap_voip_service_level psap_voip_service_level
     *
     * @return self
     */
    public function setPsapVoipServiceLevel($psap_voip_service_level)
    {
        $this->container['psap_voip_service_level'] = $psap_voip_service_level;
