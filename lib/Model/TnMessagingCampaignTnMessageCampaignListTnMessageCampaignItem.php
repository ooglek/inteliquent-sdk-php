<?php
/**
 * TnMessagingCampaignTnMessageCampaignListTnMessageCampaignItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnMessagingCampaignTnMessageCampaignListTnMessageCampaignItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnMessagingCampaignTnMessageCampaignListTnMessageCampaignItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TnMessagingCampaign_tnMessageCampaignList_tnMessageCampaignItem';
     ...
     * Sets start_date
     *
     * @param string|null $start_date Start date for the campaign
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param string|null $end_date End date for the campaign
     *
     * @return self
     */
     ...
     * Sets is_billable
     *
     * @param string|null $is_billable Y or N – to indicate if the campaign is a billable campaign or not
     *
     * @return self
     */
