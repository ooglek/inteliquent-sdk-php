...
/**
 * InlineResponse40941 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40941 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_41';
     ...
     * Sets status
     *
     * @param string|null $status Error text listing the actual error that occured |  Invalid Input Parameters:(All Input Fields)
     *
     * @return self
     */
