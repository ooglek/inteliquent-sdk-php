...
/**
 * InlineResponse414 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse414 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields)
     *
     * @return self
     */
