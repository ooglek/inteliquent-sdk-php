...
/**
 * InlineResponse41434 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41434 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_34';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Invalid Date format::The date format should be in yyyy-MM-dd |  Invalid value entered for |Large result set without searchId detected. Please contact support team for assistance.
     *
     * @return self
     */
