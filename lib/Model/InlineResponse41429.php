...
/**
 * InlineResponse41429 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41429 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_29';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Wireless not allowed for Customer
     *
     * @return self
     */
