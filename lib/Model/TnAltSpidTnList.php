...
/**
 * TnAltSpidTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active telephone number(s) to update alternative apid
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnAltSpidTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnAltSpid_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TnAltSpidTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TnAltSpidTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TnAltSpidTnListTnItem[]|null $tn_item Contains active telephone number(s) to update alternative apid
     *
     * @return self
     */
