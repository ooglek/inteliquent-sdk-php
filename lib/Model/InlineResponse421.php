...
/**
 * InlineResponse421 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse421 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_421';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 421
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Too many TNs specified in the request.
     *
     * @return self
     */
