...
/**
 * TnDisconnectTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active telephone number(s) to disconnect
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnDisconnectTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnDisconnect_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TnDisconnectTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TnDisconnectTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TnDisconnectTnListTnItem[]|null $tn_item Contains active telephone number(s) to disconnect
     *
     * @return self
     */
