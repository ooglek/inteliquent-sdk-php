...
/**
 * InlineResponse40925 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40925 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_25';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters | Invalid TN submitted | E911:Invalid origStreetInfo (# is not allowed) submitted for TN/s | CustomerOrderReference has invalid characters and cannot include <, \\\\, ^, ~, `, }, {, >, =, ], [, !
     *
     * @return self
     */
