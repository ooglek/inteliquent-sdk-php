...
class InlineObject45 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $trouble_ticket_id Existing trouble ticket number
     *
     * @return self
     */
     ...
     * Sets document_name
     *
     * @param string|null $document_name Name of document to attach
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description for document to attach
     *
     * @return self
     */
     ...
     * Sets file_content
     *
     * @param string $file_content Base64 encoded document to be attached
     *
     * @return self
     */
     ...
     * Sets is_public
     *
     * @param bool $is_public Service type; acceptable values are true and false
     *
     * @return self
     */
