...
class InlineObject41 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $primary_private_key Primary key needs to be passed into this call to ensure only authorized applications are making the call.
     *
     * @return self
     */
     ...
     * Sets private_key
     *
     * @param string $private_key Key that needs to be deleted.
     *
     * @return self
     */
