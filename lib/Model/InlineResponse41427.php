...
/**
 * InlineResponse41427 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41427 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_27';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Invalid Date format::The date format should be in yyyy-MM-dd
     *
     * @return self
     */
