...
/**
 * TfDnisTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfDnisTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfDnis_tnList_tnItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['remove_dnis'] = $data['remove_dnis'] ?? null;
    }
     ...
     * Sets dnis
     *
     * @param string|null $dnis New dnis to assign the toll free number
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getRemoveDnis()
    {
        return $this->container['remove_dnis'];
    }

    /**
     * Sets remove_dnis
     *
     * @param string|null $remove_dnis Should be set to 'Y' to remove dnis from toll free number
     *
     * @return self
     */
    public function setRemoveDnis($remove_dnis)
    {
        $this->container['remove_dnis'] = $remove_dnis;
