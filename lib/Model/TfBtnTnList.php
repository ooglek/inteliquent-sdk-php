 ...
 */
class TfBtnTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfBtn_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TfBtnTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TfBtnTnListTnItem[]
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TfBtnTnListTnItem[] $tn_item Contains active toll free number(s) to update
     *
     * @return self
     */
