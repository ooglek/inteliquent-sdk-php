...
/**
 * TfDisconnectTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfDisconnectTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfDisconnect_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit toll free number to disconnect (e.g. 8886680000)
     *
     * @return self
     */
