<?php
/**
 * PortInOrderTnListOrderListOrderType
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PortInOrderTnListOrderListOrderType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInOrderTnListOrderListOrderType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInOrderTnList_orderList_orderType';
    ...
    protected static $setters = [
        ...
        'reject_reason_name' => 'setRejectReasonName',
    ...
    protected static $getters = [
        ...
        'reject_reason_name' => 'getRejectReasonName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['process_name'] = $data['process_name'] ?? null;
        $this->container['tn_status'] = $data['tn_status'] ?? null;
        $this->container['port_date'] = $data['port_date'] ?? null;
        $this->container['reject_reason_name'] = $data['reject_reason_name'] ?? null;
     ...
     * Sets port_date
     *
     * @param \DateTime|null $port_date Port date of the order.
     *
     * @return self
     */
    ...
    /**
     * Gets reject_reason_name
     *
     * @return string|null
     */
    public function getRejectReasonName()
    {
        return $this->container['reject_reason_name'];
    }

    /**
     * Sets reject_reason_name
     *
     * @param string|null $reject_reason_name reject_reason_name
     *
     * @return self
     */
    public function setRejectReasonName($reject_reason_name)
    {
        $this->container['reject_reason_name'] = $reject_reason_name;
     ...
     * Sets lsr_number
     *
     * @param string|null $lsr_number LSR Number
     *
     * @return self
     */
