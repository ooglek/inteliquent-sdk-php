...
/**
 * InlineResponse4143 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4143 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_3';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(For All required Fields)
     *
     * @return self
     */
