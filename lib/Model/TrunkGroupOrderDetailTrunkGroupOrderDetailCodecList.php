<?php
/**
 * TrunkGroupOrderDetailTrunkGroupOrderDetailCodecList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderDetailTrunkGroupOrderDetailCodecList Class Doc Comment
 *
 * @category Class
 * @description Contains Codec Details
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TrunkGroupOrderDetailTrunkGroupOrderDetailCodecList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrunkGroupOrderDetail_trunkGroupOrderDetail_codecList';
    ...
    protected static $openAPITypes = [
        'codec_item' => '\OpenAPI\Client\Model\TrunkGroupOrderDetailTrunkGroupOrderDetailCodecListCodecItem[]'
    ];
    ...
    {
        $this->container['codec_item'] = $data['codec_item'] ?? null;
    }
     ...
     * Gets codec_item
     *
     * @return \OpenAPI\Client\Model\TrunkGroupOrderDetailTrunkGroupOrderDetailCodecListCodecItem[]|null
     */
    public function getCodecItem()
    {
        return $this->container['codec_item'];
    }

    /**
     * Sets codec_item
     *
     * @param \OpenAPI\Client\Model\TrunkGroupOrderDetailTrunkGroupOrderDetailCodecListCodecItem[]|null $codec_item codec_item
     *
     * @return self
     */
    public function setCodecItem($codec_item)
    {
        $this->container['codec_item'] = $codec_item;
