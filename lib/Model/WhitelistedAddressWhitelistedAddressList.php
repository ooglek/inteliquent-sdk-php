<?php
/**
 * WhitelistedAddressWhitelistedAddressList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * WhitelistedAddressWhitelistedAddressList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WhitelistedAddressWhitelistedAddressList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhitelistedAddress_whitelistedAddressList';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => 'string',
        'detail' => 'string',
        'result' => '\OpenAPI\Client\Model\WhitelistedAddressResult'
    ];
     ...
     * Sets success
     *
     * @param string|null $success Status of search for a particular external id.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Reason of status of search.
     *
     * @return self
     */
     ...
     * Sets detail
     *
     * @param string|null $detail Details of the search result.
     *
     * @return self
     */
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\WhitelistedAddressResult|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\WhitelistedAddressResult|null $result result
     *
     * @return self
     */
