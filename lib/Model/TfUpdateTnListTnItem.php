...
/**
 * TfUpdateTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfUpdateTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfUpdate_tnList_tnItem';
     ...
     * Sets routing_label
     *
     * @param string $routing_label New routing option to assign the toll free number; use the routingLabelSearchAssigned and routingLabelDetail operations to view your toll free routing options
     *
     * @return self
     */
     ...
     * Sets term_tn
     *
     * @param string|null $term_tn ten digit terminating tn (e.g. 7766554433); use termTn instead of routingLabel; either termTn or routingLabel allowed.
     *
     * @return self
     */
