<?php
/**
 * TnMessagingOrderTnMessagingOrderTnListTnFeature
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnMessagingOrderTnMessagingOrderTnListTnFeature Class Doc Comment
 *
 * @category Class
 * @description Contains features associated to the telephone number
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnMessagingOrderTnMessagingOrderTnListTnFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnMessagingOrder_tnMessagingOrder_tnList_tnFeature';
    ...
    protected static $openAPITypes = [
        'messaging' => '\OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnListTnFeatureMessaging'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['messaging'] === null) {
            $invalidProperties[] = "'messaging' can't be null";
        }
     ...
     * Gets messaging
     *
     * @return \OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnListTnFeatureMessaging
     */
     ...
     * Sets messaging
     *
     * @param \OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnListTnFeatureMessaging $messaging messaging
     *
     * @return self
     */
