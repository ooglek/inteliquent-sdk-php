...
/**
 * InlineResponse4601 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4601 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_460_1';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 460
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Unable to add more email notifications  | EmailItem exceeded {0} notification emails
     *
     * @return self
     */
