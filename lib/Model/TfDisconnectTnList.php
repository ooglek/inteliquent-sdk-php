...
/**
 * TfDisconnectTnList Class Doc Comment
 *
 * @category Class
 * @description Contains active toll free number(s) to disconnect
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TfDisconnectTnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfDisconnect_tnList';
    ...
    protected static $openAPITypes = [
        'tn_item' => '\OpenAPI\Client\Model\TfDisconnectTnListTnItem[]'
    ];
     ...
     * Gets tn_item
     *
     * @return \OpenAPI\Client\Model\TfDisconnectTnListTnItem[]|null
     */
     ...
     * Sets tn_item
     *
     * @param \OpenAPI\Client\Model\TfDisconnectTnListTnItem[]|null $tn_item Contains active toll free number(s) to disconnect
     *
     * @return self
     */
