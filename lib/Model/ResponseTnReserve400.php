...
/**
 * ResponseTnReserve400 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnReserve400 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnReserve400';
     ...
     * Sets status
     *
     * @param string|null $status Request format not recognized (Unrecognized fields in json)
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param string|null $status_code 400
     *
     * @return self
     */
