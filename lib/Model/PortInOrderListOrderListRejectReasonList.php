...
/**
 * PortInOrderListOrderListRejectReasonList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInOrderListOrderListRejectReasonList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInOrderList_orderList_rejectReasonList';
    ...
    protected static $openAPITypes = [
        'reject_reason_item' => '\OpenAPI\Client\Model\PortInOrderListOrderListRejectReasonListRejectReasonItem[]'
    ];
    ...
    protected static $attributeMap = [
        'reject_reason_item' => 'rejectReasonItem'
    ];
    ...
    protected static $setters = [
        'reject_reason_item' => 'setRejectReasonItem'
    ];
    ...
    protected static $getters = [
        'reject_reason_item' => 'getRejectReasonItem'
    ];
    ...
    {
        $this->container['reject_reason_item'] = $data['reject_reason_item'] ?? null;
    }
    ...
    /**
     * Gets reject_reason_item
     *
     * @return \OpenAPI\Client\Model\PortInOrderListOrderListRejectReasonListRejectReasonItem[]|null
     */
    public function getRejectReasonItem()
    {
        return $this->container['reject_reason_item'];
    }

    /**
     * Sets reject_reason_item
     *
     * @param \OpenAPI\Client\Model\PortInOrderListOrderListRejectReasonListRejectReasonItem[]|null $reject_reason_item reject_reason_item
     *
     * @return self
     */
    public function setRejectReasonItem($reject_reason_item)
    {
        $this->container['reject_reason_item'] = $reject_reason_item;
