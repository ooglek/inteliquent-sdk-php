...
/**
 * InlineResponse4205 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4205 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_420_5';
     ...
     * Sets status
     *
     * @param string|null $status Customer OCN on TN Request is not enabled
     *
     * @return self
     */
