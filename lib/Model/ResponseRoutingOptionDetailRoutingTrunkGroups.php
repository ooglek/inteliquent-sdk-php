<?php
/**
 * ResponseRoutingOptionDetailRoutingTrunkGroups
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseRoutingOptionDetailRoutingTrunkGroups Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseRoutingOptionDetailRoutingTrunkGroups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRoutingOptionDetail_routingTrunkGroups';
    ...
    protected static $openAPITypes = [
        ...
        'customer_assigned_trunk_group_name' => 'string',
        'trunk_group_sequence' => 'string',
        'trunk_group_proportion' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'customer_assigned_trunk_group_name' => null,
        'trunk_group_sequence' => null,
        'trunk_group_proportion' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'customer_assigned_trunk_group_name' => 'customerAssignedTrunkGroupName',
        'trunk_group_sequence' => 'trunkGroupSequence',
        'trunk_group_proportion' => 'trunkGroupProportion'
    ];
    ...
    protected static $setters = [
        ...
        'customer_assigned_trunk_group_name' => 'setCustomerAssignedTrunkGroupName',
        'trunk_group_sequence' => 'setTrunkGroupSequence',
        'trunk_group_proportion' => 'setTrunkGroupProportion'
    ];
    ...
    protected static $getters = [
        ...
        'customer_assigned_trunk_group_name' => 'getCustomerAssignedTrunkGroupName',
        'trunk_group_sequence' => 'getTrunkGroupSequence',
        'trunk_group_proportion' => 'getTrunkGroupProportion'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['customer_assigned_trunk_group_name'] = $data['customer_assigned_trunk_group_name'] ?? null;
        $this->container['trunk_group_sequence'] = $data['trunk_group_sequence'] ?? null;
        $this->container['trunk_group_proportion'] = $data['trunk_group_proportion'] ?? null;
    }
    ...
    /**
     * Gets customer_assigned_trunk_group_name
     *
     * @return string|null
     */
    public function getCustomerAssignedTrunkGroupName()
    {
        return $this->container['customer_assigned_trunk_group_name'];
    }

    /**
     * Sets customer_assigned_trunk_group_name
     *
     * @param string|null $customer_assigned_trunk_group_name custome assigned trunk group name
     *
     * @return self
     */
    public function setCustomerAssignedTrunkGroupName($customer_assigned_trunk_group_name)
    {
        $this->container['customer_assigned_trunk_group_name'] = $customer_assigned_trunk_group_name;

        return $this;
    }

    /**
     * Gets trunk_group_sequence
     *
     * @return string|null
     */
    public function getTrunkGroupSequence()
    {
        return $this->container['trunk_group_sequence'];
    }

    /**
     * Sets trunk_group_sequence
     *
     * @param string|null $trunk_group_sequence trunk group sequence
     *
     * @return self
     */
    public function setTrunkGroupSequence($trunk_group_sequence)
    {
        $this->container['trunk_group_sequence'] = $trunk_group_sequence;

        return $this;
    }

    /**
     * Gets trunk_group_proportion
     *
     * @return string|null
     */
    public function getTrunkGroupProportion()
    {
        return $this->container['trunk_group_proportion'];
    }

    /**
     * Sets trunk_group_proportion
     *
     * @param string|null $trunk_group_proportion trunk group proportion
     *
     * @return self
     */
    public function setTrunkGroupProportion($trunk_group_proportion)
    {
        $this->container['trunk_group_proportion'] = $trunk_group_proportion;
