<?php
/**
 * TnReserveTnReserveTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnReserveTnReserveTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnReserveTnReserveTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnReserve_tnReserve_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number requested (e.g. 3156680000)
     *
     * @return self
     */
