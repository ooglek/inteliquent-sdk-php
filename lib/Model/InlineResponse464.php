...
/**
 * InlineResponse464 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse464 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_464';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 464
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status (Generic Error)
     *
     * @return self
     */
