<?php
/**
 * ResponseCustomerNotificationCustomerNotificationEmailListEmailItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseCustomerNotificationCustomerNotificationEmailListEmailItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCustomerNotificationCustomerNotificationEmailListEmailItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCustomerNotification_customerNotification_emailList_emailItem';
     ...
     * Sets email
     *
     * @param string|null $email Email address set for the customer for notifications
     *
     * @return self
     */
