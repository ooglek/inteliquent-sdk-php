<?php
/**
 * TimeProfileSpecialDayTimeProfileSpecialDaySpecialDaySchedules
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TimeProfileSpecialDayTimeProfileSpecialDaySpecialDaySchedules Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TimeProfileSpecialDayTimeProfileSpecialDaySpecialDaySchedules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_timeProfileSpecialDay_timeProfileSpecialDay_specialDaySchedules';
     ...
     * Sets year
     *
     * @param int|null $year Start hour of the time range
     *
     * @return self
     */
     ...
     * Sets month
     *
     * @param int|null $month Start minute of the time range
     *
     * @return self
     */
     ...
     * Sets day
     *
     * @param int|null $day End hour of the time range
     *
     * @return self
     */
