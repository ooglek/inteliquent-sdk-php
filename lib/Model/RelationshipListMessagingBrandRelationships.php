<?php
/**
 * RelationshipListMessagingBrandRelationships
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * RelationshipListMessagingBrandRelationships Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RelationshipListMessagingBrandRelationships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelationshipList_messagingBrandRelationships';
    ...
    protected static $openAPITypes = [
        'brand_relationship_ref' => 'string',
        'brand_relationship_name' => 'string',
        'abbreviation' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'brand_relationship_ref' => null,
        'brand_relationship_name' => null,
        'abbreviation' => null
    ];
    ...
    protected static $attributeMap = [
        'brand_relationship_ref' => 'brandRelationshipRef',
        'brand_relationship_name' => 'brandRelationshipName',
    ...
    protected static $setters = [
        'brand_relationship_ref' => 'setBrandRelationshipRef',
        'brand_relationship_name' => 'setBrandRelationshipName',
    ...
    protected static $getters = [
        'brand_relationship_ref' => 'getBrandRelationshipRef',
        'brand_relationship_name' => 'getBrandRelationshipName',
    ...
    {
        $this->container['brand_relationship_ref'] = $data['brand_relationship_ref'] ?? null;
        $this->container['brand_relationship_name'] = $data['brand_relationship_name'] ?? null;
    ...
    /**
     * Gets brand_relationship_ref
     *
     * @return string|null
     */
    public function getBrandRelationshipRef()
    {
        return $this->container['brand_relationship_ref'];
    }

    /**
     * Sets brand_relationship_ref
     *
     * @param string|null $brand_relationship_ref Brand Relationship Reference.
     *
     * @return self
     */
    public function setBrandRelationshipRef($brand_relationship_ref)
    {
        $this->container['brand_relationship_ref'] = $brand_relationship_ref;

        return $this;
    }

    /**
     * Gets brand_relationship_name
     *
     * @return string|null
     */
    public function getBrandRelationshipName()
    {
        return $this->container['brand_relationship_name'];
    }

    /**
     * Sets brand_relationship_name
     *
     * @param string|null $brand_relationship_name Relationship name.
     *
     * @return self
     */
    public function setBrandRelationshipName($brand_relationship_name)
    {
        $this->container['brand_relationship_name'] = $brand_relationship_name;
     ...
     * Sets abbreviation
     *
     * @param string|null $abbreviation Relationship abbreviation.
     *
     * @return self
     */
