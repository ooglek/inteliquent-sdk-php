...
/**
 * TnForwardTnForwardTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnForwardTnForwardTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnForward_tnForward_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit telephone number to which the forwarding needs to be applied (e.g. 8156680000).
     *
     * @return self
     */
     ...
     * Sets forward_to
     *
     * @param string|null $forward_to Ten-digit telephone number to which the forwarding needs to be applied (e.g. 8156680000). Either ForwardTo or removeForwardTo needs to be specified.
     *
     * @return self
     */
