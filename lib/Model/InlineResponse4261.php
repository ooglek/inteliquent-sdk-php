...
/**
 * InlineResponse4261 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4261 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_426_1';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 426
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Call Forwarding is not enabled for the Account.
     *
     * @return self
     */
