<?php
/**
 * PortInOrderListOrderListFocListFocItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PortInOrderListOrderListFocListFocItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInOrderListOrderListFocListFocItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInOrderList_orderList_focList_focItem';
    ...
    {
        $this->container['port_date'] = $data['port_date'] ?? null;
