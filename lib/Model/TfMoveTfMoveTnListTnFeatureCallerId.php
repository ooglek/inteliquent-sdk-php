<?php
/**
 * TfMoveTfMoveTnListTnFeatureCallerId
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TfMoveTfMoveTnListTnFeatureCallerId Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TfMoveTfMoveTnListTnFeatureCallerId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tfMove_tfMove_tnList_tnFeature_callerId';
    ...
    protected static $openAPITypes = [
        'calling_name_operation' => 'string',
        'cnam_dip_operation' => 'string',
        'calling_name' => 'string',
        'cnam_dip' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'calling_name_operation' => null,
        'cnam_dip_operation' => null,
        'calling_name' => null,
        'cnam_dip' => null
    ];
    ...
    protected static $attributeMap = [
        'calling_name_operation' => 'callingNameOperation',
        'cnam_dip_operation' => 'cnamDipOperation',
    ...
    protected static $setters = [
        'calling_name_operation' => 'setCallingNameOperation',
        'cnam_dip_operation' => 'setCnamDipOperation',
    ...
    protected static $getters = [
        'calling_name_operation' => 'getCallingNameOperation',
        'cnam_dip_operation' => 'getCnamDipOperation',
    ...
    {
        $this->container['calling_name_operation'] = $data['calling_name_operation'] ?? null;
        $this->container['cnam_dip_operation'] = $data['cnam_dip_operation'] ?? null;
    ...
    /**
     * Gets calling_name_operation
     *
     * @return string|null
     */
    public function getCallingNameOperation()
    {
        return $this->container['calling_name_operation'];
    }

    /**
     * Sets calling_name_operation
     *
     * @param string|null $calling_name_operation Options to preserve, remove. Default is remove.
     *
     * @return self
     */
    public function setCallingNameOperation($calling_name_operation)
    {
        $this->container['calling_name_operation'] = $calling_name_operation;

        return $this;
    }

    /**
     * Gets cnam_dip_operation
     *
     * @return string|null
     */
    public function getCnamDipOperation()
    {
        return $this->container['cnam_dip_operation'];
    }

    /**
     * Sets cnam_dip_operation
     *
     * @param string|null $cnam_dip_operation Options to preserve, remove. Default is remove.
     *
     * @return self
     */
    public function setCnamDipOperation($cnam_dip_operation)
    {
        $this->container['cnam_dip_operation'] = $cnam_dip_operation;
     ...
     * Sets calling_name
     *
     * @param string|null $calling_name Caller ID display name; 15 characters or fewer and should have at least 1 alpha character
     *
     * @return self
     */
     ...
     * Sets cnam_dip
     *
     * @param string|null $cnam_dip CNAM delivery for inbound calls / CNAM dip; acceptable values are Y and N
     *
     * @return self
     */
