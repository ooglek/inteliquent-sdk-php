<?php
/**
 * AdvancedCallRoutePlanAdvancedCallRoutePlanSpecialDayRouteTimeProfile
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * AdvancedCallRoutePlanAdvancedCallRoutePlanSpecialDayRouteTimeProfile Class Doc Comment
 *
 * @category Class
 * @description Contains time profile details
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AdvancedCallRoutePlanAdvancedCallRoutePlanSpecialDayRouteTimeProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_advancedCallRoutePlan_advancedCallRoutePlan_specialDayRoute_timeProfile';
    ...
    protected static $openAPITypes = [
        'time_profile_id' => 'int',
        'time_profile_name' => 'string',
        'time_zone' => 'string',
        'special_day_schedules' => '\OpenAPI\Client\Model\TimeProfileSpecialDayTimeProfileSpecialDaySpecialDaySchedules[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'time_profile_name' => null,
        'time_zone' => null,
        'special_day_schedules' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'time_profile_name' => 'timeProfileName',
        'time_zone' => 'timeZone',
        'special_day_schedules' => 'specialDaySchedules'
    ];
    ...
    protected static $setters = [
        'time_profile_id' => 'setTimeProfileId',
        'time_profile_name' => 'setTimeProfileName',
        'time_zone' => 'setTimeZone',
        'special_day_schedules' => 'setSpecialDaySchedules'
    ];
    ...
    protected static $getters = [
        'time_profile_id' => 'getTimeProfileId',
        'time_profile_name' => 'getTimeProfileName',
        'time_zone' => 'getTimeZone',
        'special_day_schedules' => 'getSpecialDaySchedules'
    ];
    ...
    {
        $this->container['time_profile_id'] = $data['time_profile_id'] ?? null;
        $this->container['time_profile_name'] = $data['time_profile_name'] ?? null;
        $this->container['time_zone'] = $data['time_zone'] ?? null;
        $this->container['special_day_schedules'] = $data['special_day_schedules'] ?? null;
    }
    ...
    /**
     * Gets time_profile_id
     *
     * @return int|null
     */
    public function getTimeProfileId()
    {
        return $this->container['time_profile_id'];
    }

    /**
     * Sets time_profile_id
     *
     * @param int|null $time_profile_id Name of the time profile
     *
     * @return self
     */
    public function setTimeProfileId($time_profile_id)
    {
        $this->container['time_profile_id'] = $time_profile_id;

        return $this;
    }

    /**
     * Gets time_profile_name
     *
     * @return string|null
     */
    public function getTimeProfileName()
    {
        return $this->container['time_profile_name'];
    }

    /**
     * Sets time_profile_name
     *
     * @param string|null $time_profile_name Name of the time profile
     *
     * @return self
     */
    public function setTimeProfileName($time_profile_name)
    {
        $this->container['time_profile_name'] = $time_profile_name;
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone Name of the time zone to be associated with this profile
     *
     * @return self
     */
    ...
    /**
     * Gets special_day_schedules
     *
     * @return \OpenAPI\Client\Model\TimeProfileSpecialDayTimeProfileSpecialDaySpecialDaySchedules[]|null
     */
    public function getSpecialDaySchedules()
    {
        return $this->container['special_day_schedules'];
    }

    /**
     * Sets special_day_schedules
     *
     * @param \OpenAPI\Client\Model\TimeProfileSpecialDayTimeProfileSpecialDaySpecialDaySchedules[]|null $special_day_schedules Contains time profile ranges for each day of the week
     *
     * @return self
     */
    public function setSpecialDaySchedules($special_day_schedules)
    {
        $this->container['special_day_schedules'] = $special_day_schedules;
