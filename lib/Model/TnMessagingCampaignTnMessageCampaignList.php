<?php
/**
 * TnMessagingCampaignTnMessageCampaignList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnMessagingCampaignTnMessageCampaignList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnMessagingCampaignTnMessageCampaignList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TnMessagingCampaign_tnMessageCampaignList';
    ...
    protected static $openAPITypes = [
        'tn_message_campaign_item' => '\OpenAPI\Client\Model\TnMessagingCampaignTnMessageCampaignListTnMessageCampaignItem[]'
    ];
    ...
    protected static $attributeMap = [
        'tn_message_campaign_item' => 'tnMessageCampaignItem'
    ];
    ...
    protected static $setters = [
        'tn_message_campaign_item' => 'setTnMessageCampaignItem'
    ];
    ...
    protected static $getters = [
        'tn_message_campaign_item' => 'getTnMessageCampaignItem'
    ];
    ...
    {
        $this->container['tn_message_campaign_item'] = $data['tn_message_campaign_item'] ?? null;
    }
    ...
    /**
     * Gets tn_message_campaign_item
     *
     * @return \OpenAPI\Client\Model\TnMessagingCampaignTnMessageCampaignListTnMessageCampaignItem[]|null
     */
    public function getTnMessageCampaignItem()
    {
        return $this->container['tn_message_campaign_item'];
    }

    /**
     * Sets tn_message_campaign_item
     *
     * @param \OpenAPI\Client\Model\TnMessagingCampaignTnMessageCampaignListTnMessageCampaignItem[]|null $tn_message_campaign_item tn_message_campaign_item
     *
     * @return self
     */
    public function setTnMessageCampaignItem($tn_message_campaign_item)
    {
        $this->container['tn_message_campaign_item'] = $tn_message_campaign_item;
