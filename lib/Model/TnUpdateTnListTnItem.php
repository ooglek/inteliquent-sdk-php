...
/**
 * TnUpdateTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnUpdateTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnUpdate_tnList_tnItem';
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number to change trunk group (e.g. 8156680000)
     *
     * @return self
     */
