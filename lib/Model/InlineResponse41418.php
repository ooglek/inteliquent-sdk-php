...
/**
 * InlineResponse41418 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41418 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_18';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) |  ProductAbbr is required. | (Different Permission Required )
     *
     * @return self
     */
