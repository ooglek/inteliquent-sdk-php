...
/**
 * InlineResponse4185 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4185 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_418_5';
     ...
     * Sets status
     *
     * @param string|null $status Character limit is exceeded for:customerOrderReference | Character limit is exceeded for
     *
     * @return self
     */
