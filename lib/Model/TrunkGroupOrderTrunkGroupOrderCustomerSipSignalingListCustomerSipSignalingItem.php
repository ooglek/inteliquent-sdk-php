<?php
/**
 * TrunkGroupOrderTrunkGroupOrderCustomerSipSignalingListCustomerSipSignalingItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupOrderTrunkGroupOrderCustomerSipSignalingListCustomerSipSignalingItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrunkGroupOrderTrunkGroupOrderCustomerSipSignalingListCustomerSipSignalingItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_trunkGroupOrder_trunkGroupOrder_customerSipSignalingList_customerSipSignalingItem';
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address Customer SIP IP Address
     *
     * @return self
     */
     ...
     * Sets port
     *
     * @param int|null $port Customer SIP IP Port
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param string|null $direction Customer SIP direction
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Action like Add or Update or Delete
     *
     * @return self
     */
