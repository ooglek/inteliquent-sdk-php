...
/**
 * InlineResponse4202 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4202 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_420_2';
     ...
     * Sets status
     *
     * @param string|null $status Registering Campaign Credentials is not enabled
     *
     * @return self
     */
