...
/**
 * InlineResponse4141 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4141 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_1';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Messaging is not enabled for Customer | Invalid value entered for:(All Fields)
     *
     * @return self
     */
