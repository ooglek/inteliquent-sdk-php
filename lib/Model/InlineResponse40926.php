...
/**
 * InlineResponse40926 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40926 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_26';
     ...
     * Sets status
     *
     * @param string|null $status Invalid TN submitted:Must be of 10 Digits | Invalid Input Parameters:(Input Fields) | CustomerOrderReference has invalid characters and cannot include <, \\\\, ^, ~, `, }, {, >, =, ], [, !
     *
     * @return self
     */
