<?php
/**
 * ResponseTnPortOutPinPortOutPinList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseTnPortOutPinPortOutPinList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTnPortOutPinPortOutPinList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTnPortOutPin_portOutPinList';
    ...
    protected static $openAPITypes = [
        'port_out_pin_item' => '\OpenAPI\Client\Model\ResponseTnPortOutPinPortOutPinListPortOutPinItem[]'
    ];
    ...
    protected static $attributeMap = [
        'port_out_pin_item' => 'portOutPinItem'
    ];
    ...
    protected static $setters = [
        'port_out_pin_item' => 'setPortOutPinItem'
    ];
    ...
    protected static $getters = [
        'port_out_pin_item' => 'getPortOutPinItem'
    ];
    ...
    {
        $this->container['port_out_pin_item'] = $data['port_out_pin_item'] ?? null;
    }
    ...
    /**
     * Gets port_out_pin_item
     *
     * @return \OpenAPI\Client\Model\ResponseTnPortOutPinPortOutPinListPortOutPinItem[]|null
     */
    public function getPortOutPinItem()
    {
        return $this->container['port_out_pin_item'];
    }

    /**
     * Sets port_out_pin_item
     *
     * @param \OpenAPI\Client\Model\ResponseTnPortOutPinPortOutPinListPortOutPinItem[]|null $port_out_pin_item port_out_pin_item
     *
     * @return self
     */
    public function setPortOutPinItem($port_out_pin_item)
    {
        $this->container['port_out_pin_item'] = $port_out_pin_item;
