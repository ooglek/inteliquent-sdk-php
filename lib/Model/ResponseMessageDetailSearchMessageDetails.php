<?php
/**
 * ResponseMessageDetailSearchMessageDetails
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseMessageDetailSearchMessageDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseMessageDetailSearchMessageDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseMessageDetailSearch_messageDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['gate_way'] = $data['gate_way'] ?? null;
    ...
    {
        return $this->container['gate_way'];
    }

    /**
     * Sets gate_way
     *
     * @param string|null $gate_way gate_way
     *
     * @return self
     */
    public function setGateWay($gate_way)
    {
        $this->container['gate_way'] = $gate_way;
