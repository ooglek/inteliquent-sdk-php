<?php
/**
 * TnMessagingOrderTnMessagingOrderTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TnMessagingOrderTnMessagingOrderTnListTnItem Class Doc Comment
 *
 * @category Class
 * @description Contains requested telephone number(s)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TnMessagingOrderTnMessagingOrderTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnMessagingOrder_tnMessagingOrder_tnList_tnItem';
    ...
    protected static $openAPITypes = [
        ...
        'port_out_pin' => 'string',
        'tn_note' => 'string',
        'tn_feature' => '\OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnListTnFeature'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tn_feature'] === null) {
            $invalidProperties[] = "'tn_feature' can't be null";
        }
     ...
     * Sets port_out_pin
     *
     * @param string|null $port_out_pin PIN for onnet port-out protection (Tier 0 & HI), only valid on messaging-only numbers ordered from the Inteliquent inventory (not on external numbers)
     *
     * @return self
     */
     ...
     * Gets tn_feature
     *
     * @return \OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnListTnFeature
     */
     ...
     * Sets tn_feature
     *
     * @param \OpenAPI\Client\Model\TnMessagingOrderTnMessagingOrderTnListTnFeature $tn_feature tn_feature
     *
     * @return self
     */
