...
/**
 * InlineResponse40928 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse40928 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_28';
     ...
     * Sets status
     *
     * @param string|null $status Invalid Input Parameters:(Input Fields) | Invalid TN submitted
     *
     * @return self
     */
