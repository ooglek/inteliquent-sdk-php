...
/**
 * CampaignOrder Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignOrder';
     ...
     * Sets order_id
     *
     * @param int|null $order_id Order ID for the submitted request
     *
     * @return self
     */
