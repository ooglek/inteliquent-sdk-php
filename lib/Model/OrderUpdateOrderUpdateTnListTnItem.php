<?php
/**
 * OrderUpdateOrderUpdateTnListTnItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * OrderUpdateOrderUpdateTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderUpdateOrderUpdateTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orderUpdate_orderUpdate_tnList_tnItem';
    ...
    protected static $openAPITypes = [
        ...
        'tn_feature' => '\OpenAPI\Client\Model\OrderUpdateOrderUpdateTnListTnFeature'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cancel_tn'] = $data['cancel_tn'] ?? null;
     ...
     * Sets tn
     *
     * @param string|null $tn Ten-digit telephone number to apply updates
     *
     * @return self
     */
     ...
     * Sets trunk_group
     *
     * @param string|null $trunk_group New desired trunk group for the telephone number
     *
     * @return self
     */
     ...
     * Sets atn
     *
     * @param string|null $atn Billing account telephone number
     *
     * @return self
     */
     ...
     * Sets auth_date
     *
     * @param \DateTime|null $auth_date Date of port-in authorization (e.g. 2015-12-15)
     *
     * @return self
     */
     ...
     * Sets account_pin
     *
     * @param string|null $account_pin Alphanumeric account PIN or password
     *
     * @return self
     */
     ...
     * Sets account_num
     *
     * @param string|null $account_num Billing account number
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getCancelTn()
    {
        return $this->container['cancel_tn'];
    }

    /**
     * Sets cancel_tn
     *
     * @param string|null $cancel_tn Enter Y to cancel a Pending telephone number
     *
     * @return self
     */
    public function setCancelTn($cancel_tn)
    {
        $this->container['cancel_tn'] = $cancel_tn;
     ...
     * Gets tn_feature
     *
     * @return \OpenAPI\Client\Model\OrderUpdateOrderUpdateTnListTnFeature|null
     */
     ...
     * Sets tn_feature
     *
     * @param \OpenAPI\Client\Model\OrderUpdateOrderUpdateTnListTnFeature|null $tn_feature tn_feature
     *
     * @return self
     */
