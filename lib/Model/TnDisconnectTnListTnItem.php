...
/**
 * TnDisconnectTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnDisconnectTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnDisconnect_tnList_tnItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trunkgroup'] = $data['trunkgroup'] ?? null;
    }
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number to disconnect (e.g. 8156680000)
     *
     * @return self
     */
    ...
    {
        return $this->container['trunkgroup'];
    }

    /**
     * Sets trunkgroup
     *
     * @param string|null $trunkgroup Desired trunk group to assign number (e.g. CHCGI_897)
     *
     * @return self
     */
    public function setTrunkgroup($trunkgroup)
    {
        $this->container['trunkgroup'] = $trunkgroup;
