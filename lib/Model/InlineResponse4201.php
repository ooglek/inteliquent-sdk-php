...
/**
 * InlineResponse4201 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4201 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_420_1';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 420
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Please setup tcr credentials on TCR API Key page
     *
     * @return self
     */
