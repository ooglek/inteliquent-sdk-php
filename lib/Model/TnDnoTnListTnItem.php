...
/**
 * TnDnoTnListTnItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TnDnoTnListTnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tnDno_tnList_tnItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dno'] === null) {
            $invalidProperties[] = "'dno' can't be null";
        }
     ...
     * Sets tn
     *
     * @param string $tn Ten-digit telephone number to change dno (e.g. 8156680000)
     *
     * @return self
     */
     ...
     * Sets dno
     *
     * @param string $dno Update Do Not Originate value for the Tn Number; acceptable values are Y and N
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getDnoAllowableValues();
        if (!in_array($dno, $allowedValues, true)) {
