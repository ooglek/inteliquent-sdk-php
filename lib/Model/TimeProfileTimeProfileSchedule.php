<?php
/**
 * TimeProfileTimeProfileSchedule
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TimeProfileTimeProfileSchedule Class Doc Comment
 *
 * @category Class
 * @description Contains time profile ranges for each day of the week
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TimeProfileTimeProfileSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_timeProfile_timeProfile_schedule';
    ...
    protected static $openAPITypes = [
        'day_of_week' => '\OpenAPI\Client\Model\TimeProfileTimeProfileScheduleDayOfWeek[]'
    ];
     ...
     * Gets day_of_week
     *
     * @return \OpenAPI\Client\Model\TimeProfileTimeProfileScheduleDayOfWeek[]|null
     */
     ...
     * Sets day_of_week
     *
     * @param \OpenAPI\Client\Model\TimeProfileTimeProfileScheduleDayOfWeek[]|null $day_of_week Day of week for which the time range is applicable
     *
     * @return self
     */
