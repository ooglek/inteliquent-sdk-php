<?php
/**
 * ResponseAccountDefaultDetailAccountDefaultDetailNnidList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ResponseAccountDefaultDetailAccountDefaultDetailNnidList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseAccountDefaultDetailAccountDefaultDetailNnidList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAccountDefaultDetail_accountDefaultDetail_nnidList';
    ...
    protected static $openAPITypes = [
        'nnid_item' => '\OpenAPI\Client\Model\ResponseAccountDefaultDetailAccountDefaultDetailNnidListNnidItem[]'
    ];
    ...
    {
        $this->container['nnid_item'] = $data['nnid_item'] ?? null;
    }
     ...
     * Gets nnid_item
     *
     * @return \OpenAPI\Client\Model\ResponseAccountDefaultDetailAccountDefaultDetailNnidListNnidItem[]|null
     */
    public function getNnidItem()
    {
        return $this->container['nnid_item'];
    }

    /**
     * Sets nnid_item
     *
     * @param \OpenAPI\Client\Model\ResponseAccountDefaultDetailAccountDefaultDetailNnidListNnidItem[]|null $nnid_item nnid_item
     *
     * @return self
     */
    public function setNnidItem($nnid_item)
    {
        $this->container['nnid_item'] = $nnid_item;
