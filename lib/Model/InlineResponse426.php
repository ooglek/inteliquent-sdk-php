...
/**
 * InlineResponse426 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse426 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_426';
     ...
     * Sets status
     *
     * @param string|null $status Account not 911-enabled, remove e911 from request
     *
     * @return self
     */
