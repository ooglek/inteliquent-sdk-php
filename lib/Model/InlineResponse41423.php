...
/**
 * InlineResponse41423 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse41423 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_414_23';
     ...
     * Sets status
     *
     * @param string|null $status Fields Are Required:(All Required Fields) | Private Key Cannot be blank |  No. of TNs exceed limit of 100 per request
     *
     * @return self
     */
