<?php
/**
 * TrunkGroupUtilizationResponseTrunkGroupUtilListTrunkGroupUtilItem
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * TrunkGroupUtilizationResponseTrunkGroupUtilListTrunkGroupUtilItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrunkGroupUtilizationResponseTrunkGroupUtilListTrunkGroupUtilItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrunkGroupUtilizationResponse_trunkGroupUtilList_trunkGroupUtilItem';
    ...
    protected static $attributeMap = [
        'trunk_group_date' => 'trunkGroupDate',
        'in_calls' => 'inCalls',
        'out_calls' => 'outCalls',
        'capacity' => 'capacity'
    ];
    ...
    protected static $setters = [
        'trunk_group_date' => 'setTrunkGroupDate',
        'in_calls' => 'setInCalls',
        'out_calls' => 'setOutCalls',
    ...
    protected static $getters = [
        'trunk_group_date' => 'getTrunkGroupDate',
        'in_calls' => 'getInCalls',
        'out_calls' => 'getOutCalls',
    ...
    {
        $this->container['trunk_group_date'] = $data['trunk_group_date'] ?? null;
        $this->container['in_calls'] = $data['in_calls'] ?? null;
        $this->container['out_calls'] = $data['out_calls'] ?? null;
    ...
    /**
     * Gets trunk_group_date
     *
     * @return string|null
     */
    public function getTrunkGroupDate()
    {
        return $this->container['trunk_group_date'];
    }

    /**
     * Sets trunk_group_date
     *
     * @param string|null $trunk_group_date trunk_group_date
     *
     * @return self
     */
    public function setTrunkGroupDate($trunk_group_date)
    {
        $this->container['trunk_group_date'] = $trunk_group_date;
     ...
     * @return int|null
     */
    public function getInCalls()
    {
        return $this->container['in_calls'];
    }

    /**
     * Sets in_calls
     *
     * @param int|null $in_calls in_calls
     *
     * @return self
     */
    public function setInCalls($in_calls)
    {
        $this->container['in_calls'] = $in_calls;
     ...
     * @return int|null
     */
    public function getOutCalls()
    {
        return $this->container['out_calls'];
    }

    /**
     * Sets out_calls
     *
     * @param int|null $out_calls out_calls
     *
     * @return self
     */
    public function setOutCalls($out_calls)
    {
        $this->container['out_calls'] = $out_calls;
