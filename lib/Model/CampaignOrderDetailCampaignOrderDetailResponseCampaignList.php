<?php
/**
 * CampaignOrderDetailCampaignOrderDetailResponseCampaignList
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CampaignOrderDetailCampaignOrderDetailResponseCampaignList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignOrderDetailCampaignOrderDetailResponseCampaignList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignOrderDetail_campaignOrderDetailResponse_campaignList';
    ...
    protected static $openAPITypes = [
        'campaign_item' => '\OpenAPI\Client\Model\CampaignOrderDetailCampaignOrderDetailResponseCampaignListCampaignItem[]'
    ];
    ...
    {
        $this->container['campaign_item'] = $data['campaign_item'] ?? null;
    }
     ...
     * Gets campaign_item
     *
     * @return \OpenAPI\Client\Model\CampaignOrderDetailCampaignOrderDetailResponseCampaignListCampaignItem[]|null
     */
    public function getCampaignItem()
    {
        return $this->container['campaign_item'];
    }

    /**
     * Sets campaign_item
     *
     * @param \OpenAPI\Client\Model\CampaignOrderDetailCampaignOrderDetailResponseCampaignListCampaignItem[]|null $campaign_item campaign_item
     *
     * @return self
     */
    public function setCampaignItem($campaign_item)
    {
        $this->container['campaign_item'] = $campaign_item;
