...
/**
 * InlineResponse4612 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4612 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_461_2';
     ...
     * Sets status_code
     *
     * @param string|null $status_code 461
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status TN not found for the account | TN {0} Not found for the account
     *
     * @return self
     */
