<?php
/**
 * CustomerE911NotificationCustomerNotification
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * CustomerE911NotificationCustomerNotification Class Doc Comment
 *
 * @category Class
 * @description Contains notification email listinformation
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomerE911NotificationCustomerNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_customerE911Notification_customerNotification';
    ...
    protected static $openAPITypes = [
        'email_list' => '\OpenAPI\Client\Model\TnE911NotificationTnE911NotificationEmailList',
    ...
    protected static $setters = [
        ...
        'remove_notification' => 'setRemoveNotification'
    ];
    ...
    protected static $getters = [
        ...
        'remove_notification' => 'getRemoveNotification'
    ];
    ...
    {
        $this->container['email_list'] = $data['email_list'] ?? null;
        $this->container['remove_notification'] = $data['remove_notification'] ?? null;
    }
     ...
     * Gets email_list
     *
     * @return \OpenAPI\Client\Model\TnE911NotificationTnE911NotificationEmailList|null
     */
     ...
     * Sets email_list
     *
     * @param \OpenAPI\Client\Model\TnE911NotificationTnE911NotificationEmailList|null $email_list email_list
     *
     * @return self
     */
    ...
    /**
     * Gets remove_notification
     *
     * @return string|null
     */
    public function getRemoveNotification()
    {
        return $this->container['remove_notification'];
    }

    /**
     * Sets remove_notification
     *
     * @param string|null $remove_notification This flag will be used to remove notifications for specified TN (e.g. Y, N)
     *
     * @return self
     */
    public function setRemoveNotification($remove_notification)
    {
        $this->container['remove_notification'] = $remove_notification;
